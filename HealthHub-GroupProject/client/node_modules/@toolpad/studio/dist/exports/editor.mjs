...
import { CircularProgress as CircularProgress4, Box as Box38, styled as styled37, CssBaseline, Button as Button24, Stack as Stack26, Tooltip as Tooltip19 } from "@mui/material";
...
import { styled as styled25 } from "@mui/material";
...
import { Grid, styled as styled4 } from "@mui/material";
...
import { Tab as Tab2, Box as Box8, styled as styled15, Typography as Typography9, Link as Link4 } from "@mui/material";
...
import { Stack as Stack4, styled as styled12, Typography as Typography7, Divider as Divider4 } from "@mui/material";
...
// src/toolpad/propertyControls/json.tsx
var JsonEditor = lazyComponent(() => import("./JsonEditor-7DQOQPPK.mjs"), {
  noSsr: true,
...
import { Skeleton as Skeleton2, styled as styled9 } from "@mui/material";
...
// src/toolpad/AppEditor/PageEditor/JsExpressionEditor.tsx
var TypescriptEditor = lazyComponent(() => import("./TypescriptEditor-6TT6NLLG.mjs"), {
  noSsr: true,
  fallback: /* @__PURE__ */ React32.createElement(Skeleton2, { variant: "rectangular", height: "100%" })
});
var JsExpressionEditorRoot = styled9("div")(({ theme }) => ({
  height: 150,
...
import { styled as styled10, IconButton as IconButton4, Tooltip as Tooltip6, Snackbar } from "@mui/material";
...
var JsonViewRoot = styled10("div")(({ theme }) => ({
  whiteSpace: "nowrap",
  position: "relative",
  display: "flex",
  minHeight: 0,
...
import { Typography as Typography5, Divider as Divider3, Box as Box3 } from "@mui/material";
...
function GlobalScopeExplorer({ meta, value, sx }) {
  ...
  return /* @__PURE__ */ React36.createElement(Box3, { sx: { ...sx, display: "flex", flexDirection: "column" } }, /* @__PURE__ */ React36.createElement(Typography5, { sx: { ml: 1, mb: 1 }, variant: "subtitle2" }, "Scope"), /* @__PURE__ */ React36.createElement(Box3, { sx: { overflow: "auto", border: 1, borderColor: "divider" } }, /* @__PURE__ */ React36.createElement(Box3, { sx: { display: "flex", flexDirection: "column", justifyContent: "stretch" } }, Object.entries(structure).map(([key, group]) => {
...
var TabPanel = React37.forwardRef(
  ({ disableGutters, sx, ...props }, ref) => /* @__PURE__ */ React37.createElement(MuiTabPanel, { ref, sx: disableGutters ? { padding: 0, ...sx } : sx, ...props })
);
var TabPanel_default = TabPanel;

// src/toolpad/AppEditor/BindingEditor.tsx
var [useBindingEditorContext, BindingEditorContextProvider] = createProvidedContext3("BindingEditor");
var ErrorTooltip = styled11(({ className, ...props }) => /* @__PURE__ */ React38.createElement(Tooltip7, { ...props, classes: { popper: className } }))(({ theme }) => ({
...
function JsExpressionPreview({ jsRuntime, input, globalScope }) {
  ...
  return /* @__PURE__ */ React38.createElement(React38.Fragment, null, /* @__PURE__ */ React38.createElement(Toolbar, { disableGutters: true }, /* @__PURE__ */ React38.createElement(Typography6, { color: "error" }, previewError?.message)), /* @__PURE__ */ React38.createElement(JsonView, { sx: { flex: 1 }, src: lastGoodPreview?.value }));
}
function EnvBindingEditor({ value, onChange }) {
  ...
  return /* @__PURE__ */ React38.createElement(Box4, { sx: { my: 1 } }, /* @__PURE__ */ React38.createElement(Typography6, null, "Assign to an environment variable"), /* @__PURE__ */ React38.createElement(
    Autocomplete2,
    {
      freeSolo: true,
  ...
  ), "Value:", /* @__PURE__ */ React38.createElement(JsonView, { sx: { flex: 1 }, src: value?.$$env ? env[value?.$$env] : void 0 }));
}
...
function ValueBindingEditor({ value, onChange, error }) {
  ...
  const [activeTab, setActiveTab] = React38.useState(getValueBindingTab(value));
  React38.useEffect(() => {
  ...
  const jsExpressionBindingEditor = /* @__PURE__ */ React38.createElement(Stack2, { direction: "row", sx: { height: 400, gap: 2, my: hasEnv ? 3 : 0 } }, /* @__PURE__ */ React38.createElement(GlobalScopeExplorer, { sx: { width: 250 }, value: globalScope, meta: globalScopeMeta }), /* @__PURE__ */ React38.createElement(
    Box4,
    {
      sx: {
        height: "100%",
    ...
    /* @__PURE__ */ React38.createElement(Typography6, { sx: { mb: 2 } }, 'Make the "', label, '" property dynamic with a JavaScript expression. This property expects a type: ', /* @__PURE__ */ React38.createElement("code", null, propType?.type || "any"), "."),
    ...
    error ? /* @__PURE__ */ React38.createElement(
      ...
      /* @__PURE__ */ React38.createElement(Typography6, { sx: { mb: 2, color: "red" } }, "Error while reading the prettier configuration:", errorFrom(error).message ?? "The prettier config could not be loaded and therefore the code would not be formatted")
    ) : null,
    /* @__PURE__ */ React38.createElement(JsExpressionPreview, { jsRuntime, input: value, globalScope })
  ));
  const envBindingEditor = /* @__PURE__ */ React38.createElement(
    EnvBindingEditor,
    {
  ...
  return /* @__PURE__ */ React38.createElement(TabContext, { value: activeTab }, /* @__PURE__ */ React38.createElement(Box4, { sx: { borderBottom: 1, borderColor: "divider" } }, /* @__PURE__ */ React38.createElement(TabList, { onChange: handleTabChange, "aria-label": "Choose action kind " }, /* @__PURE__ */ React38.createElement(Tab, { label: "JS expression", value: "jsExpression" }), /* @__PURE__ */ React38.createElement(Tab, { label: "Environment variable", value: "env" }))), /* @__PURE__ */ React38.createElement(TabPanel_default, { value: "jsExpression", disableGutters: true }, /* @__PURE__ */ React38.createElement(Box4, { sx: { my: 1 } }, /* @__PURE__ */ React38.createElement(Typography6, null, "Bind to a JavaScript expression. Read more about binding in the", " ", /* @__PURE__ */ React38.createElement(
    Link3,
    {
    ...
    "docs"
  ), "."), jsExpressionBindingEditor)), /* @__PURE__ */ React38.createElement(TabPanel_default, { value: "env", disableGutters: true }, envBindingEditor));
}
function JsExpressionActionEditor({ value, onChange }) {
  const { globalScope, globalScopeMeta } = useBindingEditorContext();
  const handleCodeChange = React38.useCallback(
    (newValue) => onChange({ $$jsExpressionAction: newValue }),
    [onChange]
  );
  return /* @__PURE__ */ React38.createElement(Box4, { sx: { my: 1 } }, /* @__PURE__ */ React38.createElement(Typography6, null, "Run code when this event fires. Read more in the", " ", /* @__PURE__ */ React38.createElement(
    Link3,
    {
    ...
    /* @__PURE__ */ React38.createElement(GlobalScopeExplorer, { sx: { width: 250 }, value: globalScope, meta: globalScopeMeta }),
    /* @__PURE__ */ React38.createElement(
      JsExpressionEditor,
      {
        sx: { flex: 1 },
...
function NavigationActionEditor({ value, onChange }) {
  ...
  const actionParameters = React38.useMemo(
  ...
  const handleActionParameterChange = React38.useCallback(
  ...
  return /* @__PURE__ */ React38.createElement(Box4, { sx: { my: 1 } }, /* @__PURE__ */ React38.createElement(Typography6, null, "Navigate to a page on this event"), /* @__PURE__ */ React38.createElement(
    TextField9,
    {
      fullWidth: true,
      sx: { my: 3 },
    ...
    pages.map((page) => /* @__PURE__ */ React38.createElement(MenuItem2, { key: page.name, value: page.name }, page.name))
  ), actionParameterEntries.length > 0 ? /* @__PURE__ */ React38.createElement(React38.Fragment, null, /* @__PURE__ */ React38.createElement(Typography6, { variant: "overline" }, "Page parameters:"), Object.entries(actionParameters || defaultActionParameters).map((actionParameter) => {
...
function ActionEditor({ value, onChange }) {
  const [activeTab, setActiveTab] = React38.useState(getActionTab(value));
  React38.useEffect(() => setActiveTab(getActionTab(value)), [value]);
  const handleTabChange = (event, newValue) => {
    setActiveTab(newValue);
  };
  return /* @__PURE__ */ React38.createElement(TabContext, { value: activeTab }, /* @__PURE__ */ React38.createElement(Box4, { sx: { borderBottom: 1, borderColor: "divider" } }, /* @__PURE__ */ React38.createElement(TabList, { onChange: handleTabChange, "aria-label": "Choose action kind " }, /* @__PURE__ */ React38.createElement(Tab, { label: "JS expression", value: "jsExpressionAction" }), /* @__PURE__ */ React38.createElement(Tab, { label: "Navigation", value: "navigationAction" }))), /* @__PURE__ */ React38.createElement(TabPanel_default, { value: "jsExpressionAction", disableGutters: true }, /* @__PURE__ */ React38.createElement(
    JsExpressionActionEditor,
    {
      value: value?.$$jsExpressionAction ? value : null,
      onChange
    }
  )), /* @__PURE__ */ React38.createElement(TabPanel_default, { value: "navigationAction", disableGutters: true }, /* @__PURE__ */ React38.createElement(
...
function BindingEditorDialog({
  ...
  const [input, setInput] = React38.useState(value);
  React38.useEffect(() => {
    setInput(value);
  }, [open, value]);
  const committedInput = React38.useRef(input);
  const handleSave = React38.useCallback(async () => {
    let newValue = input;
  ...
  const handleCommit = React38.useCallback(() => {
    handleSave();
    onClose();
  }, [onClose, handleSave]);
  const handleRemove = React38.useCallback(() => {
  ...
  return /* @__PURE__ */ React38.createElement(
    ...
    /* @__PURE__ */ React38.createElement(DialogTitle3, null, 'Bind property "', label, '"'),
    /* @__PURE__ */ React38.createElement(
      DialogContent3,
      {
        sx: {
      ...
      propType?.type === "event" ? /* @__PURE__ */ React38.createElement(ActionEditor, { value: input, onChange: (newValue) => setInput(newValue) }) : /* @__PURE__ */ React38.createElement(
        ValueBindingEditor,
        {
          error,
    ...
    /* @__PURE__ */ React38.createElement(DialogActions3, null, /* @__PURE__ */ React38.createElement(Button4, { color: "inherit", variant: "text", onClick: onClose }, hasUnsavedChanges ? "Cancel" : "Close"), /* @__PURE__ */ React38.createElement(Button4, { color: "inherit", disabled: !value, onClick: handleRemove }, "Remove binding"), /* @__PURE__ */ React38.createElement(Button4, { disabled: !hasUnsavedChanges, color: "primary", onClick: handleCommit }, "Update binding"))
  );
}
function BindingEditor({
  ...
  const handleOpen = React38.useCallback(() => setOpen(true), []);
  const handleClose = React38.useCallback(() => setOpen(false), []);
  const hasBinding = !!value && getBindingType(value) !== "const";
  const error = liveBinding?.error?.message;
  const bindingButton = /* @__PURE__ */ React38.createElement(
    Checkbox3,
    {
      "aria-label": `Bind property "${label}"`,
      checked: hasBinding,
      disabled,
      icon: /* @__PURE__ */ React38.createElement(AddLinkIcon, { fontSize: "inherit" }),
      checkedIcon: /* @__PURE__ */ React38.createElement(LinkIcon, { fontSize: "inherit" }),
      onClick: handleOpen,
  ...
  const bindingButtonWithTooltip = disabled ? bindingButton : /* @__PURE__ */ React38.createElement(TooltipComponent, { disableInteractive: true, placement: "top", title: tooltipTitle }, bindingButton);
  const resolvedMeta = React38.useMemo(() => {
  ...
  const bindingEditorContext = React38.useMemo(
    () => ({
      label,
      globalScope,
  ...
  return /* @__PURE__ */ React38.createElement(BindingEditorContextProvider, { value: bindingEditorContext }, bindingButtonWithTooltip, /* @__PURE__ */ React38.createElement(BindingEditorDialog, { open, onClose: handleClose, value, onChange }));
}
...
function BindableEditor({
  ...
  const renderDefaultControl = React39.useCallback(
    (params) => {
      const Control = getDefaultControl(propTypeControls, params.propType);
      return Control ? /* @__PURE__ */ React39.createElement(Control, { ...params }) : null;
    },
    [propTypeControls]
  );
  const renderControl = renderControlProp || renderDefaultControl;
  const handlePropConstChange = React39.useCallback((newValue) => onChange(newValue), [onChange]);
  const valueBindingType = value && getBindingType(value);
  const initConstValue = React39.useCallback(() => {
  ...
  const constValue = React39.useMemo(initConstValue, [value, initConstValue]);
  ...
  return /* @__PURE__ */ React39.createElement(
    ...
    /* @__PURE__ */ React39.createElement(React39.Fragment, null, renderControl({
      label,
      propType,
...
function NodeAttributeEditor({
  ...
  const [propValue, setPropValue] = React40.useState(
    initialPropValue
  );
  React40.useEffect(() => {
    setPropValue(initialPropValue);
  }, [initialPropValue]);
  const handlePropChange = React40.useCallback(
    (newValue) => {
      setPropValue(newValue);
      React40.startTransition(() => {
        domApi.update(
  ...
  const scopeMeta = React40.useMemo(() => buildScopeMeta(vm, bindingScope), [vm, bindingScope]);
  const propTypeControls = usePropControlsContext();
  ...
  return Control ? /* @__PURE__ */ React40.createElement(
    BindableEditor,
    {
      liveBinding,
      ...
      renderControl: (params) => /* @__PURE__ */ React40.createElement(Box5, { sx: { flex: 1, maxWidth: "100%" } }, /* @__PURE__ */ React40.createElement(Control, { nodeId: node.id, ...params, propType: argType })),
      value: propValue,
      onChange: handlePropChange,
      sx
    }
  ) : /* @__PURE__ */ React40.createElement(Alert2, { severity: "warning" }, `No control for '${name}' (type '${argType.type}' ${argType.control ? `, control: '${argType.control.type}'` : ""})`);
}
...
function useToolpadComponent(id) {
  ...
  return React41.useMemo(() => components[id] || null, [components, id]);
}
...
var ComponentEditorRoot = styled12("div")(({ theme }) => ({
  [`& .${classes3.control}`]: {
...
function ComponentPropsEditor({
  ...
  return /* @__PURE__ */ React42.createElement(React42.Fragment, null, hasLayoutControls ? /* @__PURE__ */ React42.createElement(React42.Fragment, null, /* @__PURE__ */ React42.createElement(Typography7, { variant: "overline", className: classes3.sectionHeading }, "Layout:"), /* @__PURE__ */ React42.createElement("div", { className: classes3.control }, /* @__PURE__ */ React42.createElement(Typography7, { variant: "body2" }, "Alignment:"), /* @__PURE__ */ React42.createElement(Stack4, { direction: "row" }, hasLayoutHorizontalControls ? /* @__PURE__ */ React42.createElement(
    NodeAttributeEditor,
    {
      node,
      namespace: "layout",
  ...
  ) : null, hasLayoutVerticalControls ? /* @__PURE__ */ React42.createElement(
    NodeAttributeEditor,
    {
      node,
      namespace: "layout",
  ...
  ) : null)), /* @__PURE__ */ React42.createElement(Divider4, { sx: { mt: 1 } })) : null, Object.entries(argTypesByCategory).map(([category, argTypeEntries]) => /* @__PURE__ */ React42.createElement(React42.Fragment, { key: category }, /* @__PURE__ */ React42.createElement(Typography7, { variant: "overline", className: classes3.sectionHeading }, category, ":"), argTypeEntries.map(
    ([propName, propTypeDef]) => propTypeDef && shouldRenderControl(propTypeDef, propName, props) ? /* @__PURE__ */ React42.createElement("div", { key: propName, className: classes3.control }, /* @__PURE__ */ React42.createElement(
      NodeAttributeEditor,
      {
        node,
        namespace: "props",
...
function SelectedNodeEditor({ node }) {
  ...
  return /* @__PURE__ */ React42.createElement(ElementContext_default.Provider, { value: node }, /* @__PURE__ */ React42.createElement(Stack4, { direction: "column", gap: 0 }, /* @__PURE__ */ React42.createElement(MarkdownTooltip, { placement: "left", title: componentConfig.helperText ?? displayName }, /* @__PURE__ */ React42.createElement(Typography7, { variant: "body1" }, node.name)), /* @__PURE__ */ React42.createElement(Divider4, { sx: { mt: 1 } }), node ? /* @__PURE__ */ React42.createElement(ComponentPropsEditor, { bindings, componentConfig, node }) : null));
}
function ComponentEditor({ node, className }) {
  return /* @__PURE__ */ React42.createElement(ComponentEditorRoot, { className, "data-testid": "component-editor" }, /* @__PURE__ */ React42.createElement(SelectedNodeEditor, { key: node.id, node }));
}
...
var TooltipRadio = React43.forwardRef(
...
function ColorTool({ sx, label, value, onChange }) {
  ...
  return /* @__PURE__ */ React43.createElement(Box6, { sx }, /* @__PURE__ */ React43.createElement(Typography8, { component: "label", gutterBottom: true, htmlFor: id, variant: "h6" }, label), /* @__PURE__ */ React43.createElement(
    Input,
    {
      id,
      value: intentInput,
  ...
  ), /* @__PURE__ */ React43.createElement(Box6, { sx: { display: "flex", alignItems: "center", mt: 2, mb: 2 } }, /* @__PURE__ */ React43.createElement(Typography8, { id: `${id}ShadeSliderLabel` }, "Shade:"), /* @__PURE__ */ React43.createElement(
    Slider,
    {
  ...
  ), /* @__PURE__ */ React43.createElement(Typography8, null, shades[intentShade])), /* @__PURE__ */ React43.createElement(Box6, { sx: { width: 192, margin: "auto" } }, hues.map((hue) => {
    const shade = shades[state.shade];
    const backgroundColor = colors[hue][shade];
    return /* @__PURE__ */ React43.createElement(Tooltip8, { placement: "right", title: hue, key: hue, disableInteractive: true }, /* @__PURE__ */ React43.createElement(
      TooltipRadio,
      {
        sx: { p: 0 },
        color: "default",
        ...
        value: hue,
        name: label,
        icon: /* @__PURE__ */ React43.createElement(Box6, { sx: { width: 48, height: 48 }, style: { backgroundColor } }),
        checkedIcon: /* @__PURE__ */ React43.createElement(
          Box6,
          {
            sx: {
              width: 48,
          ...
          /* @__PURE__ */ React43.createElement(CheckIcon, { style: { fontSize: 30 } })
        )
      }
    ));
  })), /* @__PURE__ */ React43.createElement(Stack5, { direction: "row", sx: { mt: 2, justifyContent: "center" } }, ["dark", "main", "light"].map((key) => /* @__PURE__ */ React43.createElement(
    Box6,
    {
      sx: {
        width: 64,
...
var FlexFill = styled13("div")({ flex: 1 });
var FlexFill_default = FlexFill;

// src/components/MuiThemeEditor.tsx
var IconToggleButton = styled14(ToggleButton2)({
  display: "flex",
  justifyContent: "center",
  width: "100%",
  "& > *": {
...
function PaletteColorPicker({ label, value, onChange }) {
  ...
  const [anchorEl, setAnchorEl] = React44.useState(null);
  ...
  return /* @__PURE__ */ React44.createElement(React44.Fragment, null, /* @__PURE__ */ React44.createElement(Button5, { "aria-describedby": id, variant: "outlined", onClick: handleClick }, label, /* @__PURE__ */ React44.createElement(FlexFill_default, null), /* @__PURE__ */ React44.createElement(
    Box7,
    {
      sx: {
        ml: 2,
    ...
    /* @__PURE__ */ React44.createElement(ColorTool_default, { sx: { m: 2 }, label, value, onChange })
  ));
}
function MuiThemeEditor({ value, onChange }) {
  const theme = useTheme3();
  const defaultTheme = React44.useMemo(
    () => createTheme({ palette: { mode: value?.palette?.mode } }),
    [value?.palette?.mode]
  );
  const colorPicker = (intent) => /* @__PURE__ */ React44.createElement(
    PaletteColorPicker,
    {
  ...
  return /* @__PURE__ */ React44.createElement(Stack6, { direction: "column", spacing: 2 }, /* @__PURE__ */ React44.createElement(
    ToggleButtonGroup2,
    {
      exclusive: true,
    ...
    /* @__PURE__ */ React44.createElement(IconToggleButton, { value: "light", "aria-label": "light" }, /* @__PURE__ */ React44.createElement(LightModeIcon, null), "Light"),
    /* @__PURE__ */ React44.createElement(IconToggleButton, { value: "dark", "aria-label": "dark" }, /* @__PURE__ */ React44.createElement(DarkModeIcon, null), "Dark")
...
function ComponentEditor2({ className }) {
  ...
  return /* @__PURE__ */ React45.createElement("div", { className, "data-testid": "theme-editor" }, /* @__PURE__ */ React45.createElement(
    MuiThemeEditor,
    {
      value: theme?.theme || {},
      onChange: (newTheme) => {
...
var ComponentPanelRoot = styled15("div")(({ theme }) => ({
  display: "flex",
  flexDirection: "column",
  height: "100%",
  [`& .${classes4.panel}`]: {
...
function ComponentPanel({ className }) {
  ...
  return /* @__PURE__ */ React46.createElement(ComponentPanelRoot, { className }, /* @__PURE__ */ React46.createElement(TabContext2, { value: currentTab || "page" }, /* @__PURE__ */ React46.createElement(Box8, { sx: { borderBottom: 1, borderColor: "divider" } }, /* @__PURE__ */ React46.createElement(TabList2, { onChange: handleChange, "aria-label": "Component options" }, /* @__PURE__ */ React46.createElement(Tab2, { label: "Page", value: "page" }), /* @__PURE__ */ React46.createElement(Tab2, { label: "Component", value: "component", disabled: !selectedNode }), /* @__PURE__ */ React46.createElement(Tab2, { label: "Theme", value: "theme" }))), /* @__PURE__ */ React46.createElement(TabPanel2, { value: "page", className: classes4.panel }, /* @__PURE__ */ React46.createElement(PageOptionsPanel, null)), /* @__PURE__ */ React46.createElement(TabPanel2, { value: "component", className: classes4.panel }, selectedNode && appDom16.isElement(selectedNode) ? /* @__PURE__ */ React46.createElement(ComponentEditor, { node: selectedNode }) : /* @__PURE__ */ React46.createElement(Typography9, { variant: "body1" }, "No component selected.")), /* @__PURE__ */ React46.createElement(TabPanel2, { value: "theme", className: classes4.panel }, /* @__PURE__ */ React46.createElement(Typography9, { className: classes4.themesDocsLink, variant: "body2" }, "Customize the app with a Material\xA0UI theme. Read more about theming in the", " ", /* @__PURE__ */ React46.createElement(
    Link4,
    {
    ...
    "docs"
  ), "."), /* @__PURE__ */ React46.createElement(ComponentEditor2, null))));
}
...
import { ButtonBase, Box as Box9 } from "@mui/material";
...
function ComponentIcon({ id: componentId, kind, sx }) {
  const Icon = iconMap.get(kind === "custom" ? "CodeComponent" : componentId);
  return Icon ? /* @__PURE__ */ React47.createElement(Icon, { sx: { fontSize: 24, opacity: kind === "future" ? 0.75 : 1, ...sx } }) : null;
}
function ComponentCatalogItem({
  ...
  return /* @__PURE__ */ React47.createElement(
    ...
    /* @__PURE__ */ React47.createElement(ComponentIcon, { id, kind }),
...
import { styled as styled16 } from "@mui/material";
var StyledDialogForm = styled16("form")({
  overflowY: "auto",
  display: "flex",
  flexDirection: "column"
});
function DialogForm({ children, onKeyDown = () => {
  ...
  return /* @__PURE__ */ React48.createElement(StyledDialogForm, { onKeyDown: handleKeyDown, ...rest }, children);
}
...
function MissingEditorDialog({ open, onClose }) {
  const handleMissingEditorDialogClose = React49.useCallback(() => {
    onClose(false);
  }, [onClose]);
  ...
  return /* @__PURE__ */ React49.createElement(
    ...
    /* @__PURE__ */ React49.createElement(DialogTitle4, { id: `${id}-title` }, "Editor not found"),
    /* @__PURE__ */ React49.createElement(DialogContent4, null, /* @__PURE__ */ React49.createElement(DialogContentText, { id: "alert-dialog-description" }, 'No editor was detected on your system. If you use Visual Studio Code, this may be due to a missing "code" command in your PATH. Otherwise you can set the', " ", /* @__PURE__ */ React49.createElement("code", null, "$EDITOR"), " environment variable. ", /* @__PURE__ */ React49.createElement("br", null), "Check the", " ", /* @__PURE__ */ React49.createElement(
      Link5,
      {
    ...
    /* @__PURE__ */ React49.createElement(DialogActions4, null, /* @__PURE__ */ React49.createElement(Button6, { onClick: handleMissingEditorDialogClose }, "Dismiss"))
  );
}
function OpenCodeEditorButton({
  ...
  const [missingEditorDialog, setMissingEditorDialog] = React49.useState(false);
  ...
  return /* @__PURE__ */ React49.createElement(React49.Fragment, null, iconButton ? /* @__PURE__ */ React49.createElement(Tooltip9, { title: "Open in code editor" }, /* @__PURE__ */ React49.createElement(IconButton5, { disabled: disabled || busy, size: "small", onClick: handleClick, ...rest }, busy ? /* @__PURE__ */ React49.createElement(CircularProgress, { color: "inherit", size: 16 }) : /* @__PURE__ */ React49.createElement(CodeIcon, { fontSize: "inherit", color: "primary" }))) : /* @__PURE__ */ React49.createElement(
    LoadingButton,
    {
      disabled: disabled || busy,
      onClick: handleClick,
      loading: busy,
      startIcon: rest.variant === "outlined" ? /* @__PURE__ */ React49.createElement(CodeIcon, { fontSize: "inherit", color: "primary" }) : null,
      ...rest
    },
    actionText
  ), /* @__PURE__ */ React49.createElement(MissingEditorDialog, { open: missingEditorDialog, onClose: setMissingEditorDialog }));
}
...
function CreateCodeComponentDialog({
  ...
  const existingNames = React50.useMemo(
    () => new Set(
      Object.values(codeComponents).map((component) => component?.displayName).filter(Boolean)
    ),
    [codeComponents]
  );
  const [name, setName] = React50.useState(appDom17.proposeName(DEFAULT_NAME, existingNames));
  ...
  const [snackbarState, setSnackbarState] = React50.useState(null);
  const lastSnackbarState = useLatest2(snackbarState);
  const handleSnackbarClose = React50.useCallback(() => {
    setSnackbarState(null);
  }, []);
  return /* @__PURE__ */ React50.createElement(React50.Fragment, null, /* @__PURE__ */ React50.createElement(Dialog5, { open, onClose, ...props }, /* @__PURE__ */ React50.createElement(
    DialogForm,
    {
      autoComplete: "off",
    ...
    /* @__PURE__ */ React50.createElement(DialogTitle5, null, "Create a new Code Component"),
    /* @__PURE__ */ React50.createElement(DialogContent5, null, /* @__PURE__ */ React50.createElement(
      TextField10,
      {
        sx: { my: 1 },
        required: true,
    ...
    /* @__PURE__ */ React50.createElement(DialogActions5, null, /* @__PURE__ */ React50.createElement(Button7, { color: "inherit", variant: "text", onClick: onClose }, "Cancel"), /* @__PURE__ */ React50.createElement(Button7, { type: "submit", disabled: !isFormValid }, "Create"))
  )), lastSnackbarState ? /* @__PURE__ */ React50.createElement(Portal, null, /* @__PURE__ */ React50.createElement(
    Snackbar2,
    {
      open: !!snackbarState,
      ...
      action: /* @__PURE__ */ React50.createElement(React50.Fragment, null, /* @__PURE__ */ React50.createElement(
        ...
        /* @__PURE__ */ React50.createElement(CloseIcon, { fontSize: "small" })
      ))
    }
  )) : null);
}
...
function useLocalStorageState(key, initialValue) {
  ...
  const value = React51.useMemo(() => JSON.parse(input), [input]);
  const handleChange = React51.useCallback(
    (newValue) => setInput(
...
import { Tooltip as Tooltip10 } from "@mui/material";
import HelpOutlineIcon from "@mui/icons-material/HelpOutline";
function HelpTooltipIcon({ helpText, sx, ...props }) {
  return /* @__PURE__ */ React52.createElement(Tooltip10, { title: helpText }, /* @__PURE__ */ React52.createElement(HelpOutlineIcon, { ...props, sx: { color: "text.secondary", ...sx } }));
}
...
var ComponentCatalogRoot = styled17("div")({
  position: "relative",
...
function ComponentCatalog({ className }) {
  const api = usePageEditorApi();
  const { dom } = useAppState();
  const [searchTerm, setSearchTerm] = React53.useState("");
  const [searchFocused, setSearchFocused] = React53.useState(false);
  const [openStart, setOpenStart] = React53.useState(0);
  ...
  const closeTimeoutRef = React53.useRef();
  const openDrawer = React53.useCallback(() => {
    if (closeTimeoutRef.current) {
      clearTimeout(closeTimeoutRef.current);
    }
    setOpenStart(Date.now());
  }, []);
  const closeDrawer = React53.useCallback(
    (delay) => {
  ...
  const handleMouseEnter = React53.useCallback(() => openDrawer(), [openDrawer]);
  const handleMouseLeave = React53.useCallback(() => closeDrawer(), [closeDrawer]);
  const [createCodeComponentDialogOpen, setCreateCodeComponentDialogOpen] = React53.useState(false);
  const handleCreateCodeComponentDialogOpen = React53.useCallback(() => {
    setCreateCodeComponentDialogOpen(true);
    closeDrawer(0);
  }, [closeDrawer]);
  const handleCreateCodeComponentDialogClose = React53.useCallback(
  ...
  return /* @__PURE__ */ React53.createElement(React53.Fragment, null, /* @__PURE__ */ React53.createElement(
    ...
    /* @__PURE__ */ React53.createElement(
      ...
      /* @__PURE__ */ React53.createElement(
        ...
        /* @__PURE__ */ React53.createElement(Box10, { sx: { flexDirection: "column", display: "flex", height: "100%" } }, /* @__PURE__ */ React53.createElement(
          Box10,
          {
            sx: {
              width: "100%",
          ...
          /* @__PURE__ */ React53.createElement(
            TextField11,
            {
              ...
              InputProps: {
                startAdornment: /* @__PURE__ */ React53.createElement(InputAdornment2, { position: "start" }, /* @__PURE__ */ React53.createElement(AccountCircle, null))
              },
          ...
          /* @__PURE__ */ React53.createElement(Box10, { display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 1, padding: 1 }, filteredItems.map(([componentId, componentType]) => {
            invariant8(componentType, `No component definition found for "${componentId}"`);
            return componentType.builtIn && !componentType.system ? /* @__PURE__ */ React53.createElement(
          ...
          /* @__PURE__ */ React53.createElement(
            ...
            /* @__PURE__ */ React53.createElement(Box10, { display: "flex", alignItems: "center" }, /* @__PURE__ */ React53.createElement(Typography10, { mr: 0.5, variant: "overline" }, "Custom Components"), /* @__PURE__ */ React53.createElement(
              HelpTooltipIcon,
              {
                helpText: /* @__PURE__ */ React53.createElement(Typography10, { variant: "inherit" }, "Expand Toolpad Studio with your own React components.", " ", /* @__PURE__ */ React53.createElement(
                  Link6,
                  {
            ...
            /* @__PURE__ */ React53.createElement(
              ...
              /* @__PURE__ */ React53.createElement(ArrowDropDownSharpIcon, null)
            )
          ),
          /* @__PURE__ */ React53.createElement(Collapse, { in: openCustomComponents, orientation: "vertical" }, /* @__PURE__ */ React53.createElement(Box10, { display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 1, padding: 1, pt: 0 }, filteredItems.map(([componentId, componentType]) => {
            invariant8(
              componentType,
              `No component definition found for "${componentId}"`
            );
            return !componentType.builtIn ? /* @__PURE__ */ React53.createElement(
              ComponentCatalogItem_default,
              {
                key: componentId,
                id: componentId,
          ...
          /* @__PURE__ */ React53.createElement(Box10, { padding: 1 }, /* @__PURE__ */ React53.createElement(
            Box10,
            {
              sx: (theme) => ({
                py: 2,
            ...
            /* @__PURE__ */ React53.createElement(Box10, { pb: 0, display: "flex", flexDirection: "row", justifyContent: "space-between" }, /* @__PURE__ */ React53.createElement(Typography10, { variant: "body2", color: "text.secondary" }, "More components coming soon!"), /* @__PURE__ */ React53.createElement(
              IconButton7,
              {
                "aria-label": "Expand custom components",
                sx: {
            ...
            /* @__PURE__ */ React53.createElement(Collapse, { in: openFutureComponents, orientation: "vertical" }, /* @__PURE__ */ React53.createElement(Typography10, { variant: "caption", color: "text.secondary" }, "\u{1F44D} Upvote on GitHub to get it prioritized."), /* @__PURE__ */ React53.createElement(Box10, { display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 1, pt: 1, pb: 0 }, Array.from(FUTURE_COMPONENTS, ([key, { displayName, url }]) => {
      ...
      /* @__PURE__ */ React53.createElement(
        ...
        /* @__PURE__ */ React53.createElement(Box10, { sx: { mt: 2 } }, openStart ? /* @__PURE__ */ React53.createElement(ArrowLeftIcon, null) : /* @__PURE__ */ React53.createElement(ArrowRightIcon, null)),
        /* @__PURE__ */ React53.createElement(Box10, { position: "relative" }, /* @__PURE__ */ React53.createElement(
          Typography10,
          {
            sx: {
              position: "absolute",
...
import { Box as Box11, Alert as Alert3 } from "@mui/material";
import * as React54 from "react";
function NotFoundEditor({ className, message, severity }) {
  return /* @__PURE__ */ React54.createElement(Box11, { className, sx: { p: 3 } }, /* @__PURE__ */ React54.createElement(Alert3, { severity: severity ?? "warning" }, message));
}
...
function useUndoRedo() {
  ...
  const handleUndo = React55.useCallback(
    (event) => {
  ...
  const handleRedo = React55.useCallback(
    (event) => {
      if (currentView.kind === "page" && !currentPageView) {
        event.preventDefault();
        appStateApi.redo();
...
function QueryIcon({ id: iconId, mode, sx }) {
  ...
  return /* @__PURE__ */ React56.createElement("div", { style: { display: "flex", gap: 0.5 } }, ModeIcon ? /* @__PURE__ */ React56.createElement(
    ModeIcon,
    {
      sx: {
        fontSize: 12,
  ...
  ) : null, DataSourceIcon ? /* @__PURE__ */ React56.createElement(DataSourceIcon, { sx }) : null);
}
...
function ApiKeyAuthEditor({ disabled, value, onChange }) {
  return /* @__PURE__ */ React57.createElement(Stack7, { gap: 1 }, /* @__PURE__ */ React57.createElement(
    TextField12,
    {
      disabled,
      label: "header",
...
function AuthenticationDetailsEditor({ value, ...props }) {
  switch (value.type) {
    case "basic":
      return /* @__PURE__ */ React57.createElement(BasicAuthEditor, { value, ...props });
    case "bearerToken":
      return /* @__PURE__ */ React57.createElement(BearerTokenAuthEditor, { value, ...props });
    case "apiKey":
      return /* @__PURE__ */ React57.createElement(ApiKeyAuthEditor, { value, ...props });
    default:
...
function AuthenticationEditor({
  ...
  const handleTypeChange = React57.useCallback(
    (event) => {
      onChange(getInitialAuthenticationValue(event.target.value));
    },
    [onChange]
  );
  return /* @__PURE__ */ React57.createElement(Grid2, { container: true, spacing: 1 }, /* @__PURE__ */ React57.createElement(Grid2, { item: true, xs: 4 }, /* @__PURE__ */ React57.createElement(
    TextField12,
    {
      disabled,
      select: true,
    ...
    /* @__PURE__ */ React57.createElement(MenuItem3, { value: "" }, "No authentication"),
    /* @__PURE__ */ React57.createElement(MenuItem3, { value: "basic" }, "Basic"),
    /* @__PURE__ */ React57.createElement(MenuItem3, { value: "bearerToken" }, "Bearer token"),
    /* @__PURE__ */ React57.createElement(MenuItem3, { value: "apiKey" }, "API key")
  )), /* @__PURE__ */ React57.createElement(Grid2, { item: true, xs: 4 }, value ? /* @__PURE__ */ React57.createElement(AuthenticationDetailsEditor, { disabled, value, onChange }) : null));
}
...
import { Box as Box12, TextField as TextField13, IconButton as IconButton8, inputLabelClasses } from "@mui/material";
...
function ParametersEditor({
  ...
  const fieldInputRef = React58.useRef(null);
  const handleRemove = React58.useCallback(
    (index) => () => {
      onChange(value.filter((entry, i) => i !== index));
    },
    [onChange, value]
  );
  const isValidFieldName = React58.useMemo(() => {
    const counts = {};
    value.forEach(([field]) => {
      counts[field] = counts[field] ? counts[field] + 1 : 1;
    });
  ...
  return /* @__PURE__ */ React58.createElement(
    ...
    label ? /* @__PURE__ */ React58.createElement(Box12, { gridColumn: "span 3" }, label, ":") : null,
    value.map(([field, fieldValue], index) => {
      const liveBinding = liveValue[index]?.[1];
      return /* @__PURE__ */ React58.createElement(React58.Fragment, { key: index }, /* @__PURE__ */ React58.createElement(
        TextField13,
        {
          label: valueLabel,
          value: field,
        ...
        /* @__PURE__ */ React58.createElement(DeleteIcon3, { fontSize: "inherit" })
      ));
    }),
    /* @__PURE__ */ React58.createElement("form", { autoComplete: "off", style: { display: "contents" } }, /* @__PURE__ */ React58.createElement(
      TextField13,
      {
        inputRef: fieldInputRef,
        label: fieldLabel,
...
var BodyEditorToolbar = styled19((props) => /* @__PURE__ */ React59.createElement(React59.Fragment, null, /* @__PURE__ */ React59.createElement(Toolbar2, { disableGutters: true, ...props }), /* @__PURE__ */ React59.createElement(Divider5, null)))(({ theme }) => ({
  gap: theme.spacing(1),
  marginBottom: theme.spacing(1)
}));
var MonacoEditor = lazyComponent(() => import("./MonacoEditor-LHYEAJ7X.mjs"), {
  noSsr: true,
  fallback: /* @__PURE__ */ React59.createElement(Skeleton3, { variant: "rectangular", height: "100%" })
});
function RawBodyEditor({
  ...
  const handleContentTypeChange = React59.useCallback(
    (event) => {
  ...
  return /* @__PURE__ */ React59.createElement(React59.Fragment, null, renderToolbar({
    actions: /* @__PURE__ */ React59.createElement(
      TextField14,
      {
        select: true,
        label: "content-type",
      ...
      Array.from(RAW_CONTENT_TYPES.entries(), ([contentType, { alias }]) => /* @__PURE__ */ React59.createElement(MenuItem4, { key: contentType, value: contentType }, alias))
    )
    ...
    BindableEditor,
    {
      ...
      propType: { type: "string" },
      jsRuntime: jsServerRuntime,
      renderControl: (props) => /* @__PURE__ */ React59.createElement(
        MonacoEditor,
        {
...
function UrlEncodedBodyEditor({
  ...
  const handleParamsChange = React59.useCallback(
    (newContent) => {
      onChange({ ...value, content: newContent });
    },
    [onChange, value]
  ...
  return /* @__PURE__ */ React59.createElement(React59.Fragment, null, renderToolbar(), /* @__PURE__ */ React59.createElement(
    ParametersEditor,
    {
      sx: { mt: 1 },
      value: value.content,
...
function BodyEditor({
  ...
  const [activeTab, setActiveTab] = React59.useState(value?.kind || "raw");
  React59.useEffect(() => setActiveTab(value?.kind || "raw"), [value?.kind]);
  const handleTabChange = (event) => {
    setActiveTab(event.target.value);
  };
  const method = methodProp || "GET";
  const disabled = HTTP_NO_BODY.has(method);
  const renderToolbar = React59.useCallback(
    ({ actions } = {}) => /* @__PURE__ */ React59.createElement(BodyEditorToolbar, null, /* @__PURE__ */ React59.createElement(
      TextField14,
      {
        label: "body",
        select: true,
      ...
      /* @__PURE__ */ React59.createElement(MenuItem4, { value: "raw" }, "raw"),
      /* @__PURE__ */ React59.createElement(MenuItem4, { value: "urlEncoded" }, "x-www-form-urlencoded")
    ), actions),
    [activeTab, disabled]
  );
  return /* @__PURE__ */ React59.createElement(Box13, { sx: { ...sx, position: "relative" } }, /* @__PURE__ */ React59.createElement(TabContext3, { value: activeTab }, /* @__PURE__ */ React59.createElement(TabPanel_default, { disableGutters: true, value: "raw" }, /* @__PURE__ */ React59.createElement(
    RawBodyEditor,
    {
      renderToolbar,
      globalScope,
  ...
  )), /* @__PURE__ */ React59.createElement(TabPanel_default, { disableGutters: true, value: "urlEncoded" }, /* @__PURE__ */ React59.createElement(
  ...
  ))), HTTP_NO_BODY.has(method) ? /* @__PURE__ */ React59.createElement(
    Box13,
    {
      sx: {
        position: "absolute",
    ...
    /* @__PURE__ */ React59.createElement(Typography11, { color: "info", variant: "body2" }, '"', method, `" requests can't have a body`)
  ) : null);
}
...
function useQueryPreview(dofetch, query, params, { onPreview } = {}) {
  const [preview, setPreview] = React60.useState(null);
  const [isLoading, setIsLoading] = React60.useState(false);
  const cancelRunPreview = React60.useRef(null);
  const runPreview = React60.useCallback(() => {
    let canceled = false;
...
import { Stack as Stack8, Grid as Grid3, Checkbox as Checkbox4, FormControlLabel as FormControlLabel3, IconButton as IconButton9 } from "@mui/material";
...
function TransformInput({
  ...
  const handleTransformEnabledChange = React61.useCallback(
    (event) => onEnabledChange(event.target.checked),
    [onEnabledChange]
  );
  return /* @__PURE__ */ React61.createElement(Grid3, { item: true, xs: 6, md: 12 }, /* @__PURE__ */ React61.createElement(Stack8, null, /* @__PURE__ */ React61.createElement(
    FormControlLabel3,
    {
      ...
      control: /* @__PURE__ */ React61.createElement(
        Checkbox4,
        {
          checked: enabled,
          sx: { p: 0.25, pl: 1 },
  ...
  ), /* @__PURE__ */ React61.createElement(Stack8, { direction: "row", spacing: 2, width: "100%" }, /* @__PURE__ */ React61.createElement(
    JsonView,
    {
      src: globalScope,
  ...
  ), onUpdatePreview ? /* @__PURE__ */ React61.createElement(
    IconButton9,
    {
      disabled: !enabled,
  ...
  ) : null, /* @__PURE__ */ React61.createElement(
    JsExpressionEditor,
    {
      globalScope,
...
import { Box as Box15, IconButton as IconButton10, LinearProgress, styled as styled21, Tab as Tab3 } from "@mui/material";
import DoDisturbIcon from "@mui/icons-material/DoDisturb";

// src/components/Console.tsx
import { darken as darken2, lighten, styled as styled20 } from "@mui/material";
...
var ConsoleRoot = styled20("div")(({ theme }) => {
...
function ConsoleEntry({ entry }) {
  return /* @__PURE__ */ React62.createElement("div", { className: clsx4(classes5.logEntry, entry.level) }, /* @__PURE__ */ React62.createElement("div", { className: classes5.logEntryText }, interleave(
    entry.args.map(
      (arg, i) => typeof arg === "string" ? arg : /* @__PURE__ */ React62.createElement(ObjectInspector_default, { key: i, data: arg })
    ),
    " "
  )));
}
function Console({ value = [], sx }) {
  return /* @__PURE__ */ React62.createElement(ConsoleRoot, { sx }, /* @__PURE__ */ React62.createElement("div", { className: classes5.logEntriesContainer }, /* @__PURE__ */ React62.createElement("div", { className: classes5.logEntries }, value.map((entry, i) => /* @__PURE__ */ React62.createElement(ConsoleEntry, { key: i, entry })))));
}

// src/components/CenteredSpinner.tsx
import { CircularProgress as CircularProgress2, Box as Box14 } from "@mui/material";
...
function CenteredSpinner({ sx }) {
  return /* @__PURE__ */ React63.createElement(
    ...
    /* @__PURE__ */ React63.createElement(CircularProgress2, null)
  );
}

// src/components/Devtools.tsx
var HarViewer = lazyComponent(() => import("./HarViewer-GR5WGCMI.mjs"), {
  fallback: /* @__PURE__ */ React64.createElement(CenteredSpinner, null)
});
var DebuggerTabPanel = styled21(TabPanel3)({ padding: 0, flex: 1, minHeight: 0 });
function Devtools({ sx, log, onLogClear, har, onHarClear }) {
  const [activeTab, setActiveTab] = React64.useState(() => {
    if (log) {
      return "console";
    }
    if (har) {
  ...
  const clearEnabled = React64.useMemo(() => {
    switch (activeTab) {
      case "console":
        return logLength > 0;
      case "network":
  ...
  const handleClearClick = React64.useCallback(() => {
    switch (activeTab) {
      case "console":
        return onLogClear?.();
      case "network":
  ...
  return /* @__PURE__ */ React64.createElement(
    ...
    /* @__PURE__ */ React64.createElement(TabContext4, { value: activeTab }, /* @__PURE__ */ React64.createElement(
      Box15,
      {
        sx: {
          borderBottom: 1,
      ...
      handleClearClick ? /* @__PURE__ */ React64.createElement(IconButton10, { disabled: !clearEnabled, onClick: handleClearClick }, /* @__PURE__ */ React64.createElement(DoDisturbIcon, null)) : null,
      /* @__PURE__ */ React64.createElement(
        ...
        log ? /* @__PURE__ */ React64.createElement(
          Tab3,
          {
            label: "Console",
            value: "console",
        ...
        har ? /* @__PURE__ */ React64.createElement(
          Tab3,
          {
            label: "Network",
            value: "network",
    ...
    ), log ? /* @__PURE__ */ React64.createElement(DebuggerTabPanel, { value: "console" }, /* @__PURE__ */ React64.createElement(Console, { sx: { flex: 1 }, value: log })) : null, har ? /* @__PURE__ */ React64.createElement(DebuggerTabPanel, { value: "network" }, /* @__PURE__ */ React64.createElement(React64.Suspense, { fallback: /* @__PURE__ */ React64.createElement(LinearProgress, null) }, /* @__PURE__ */ React64.createElement(HarViewer, { sx: { flex: 1 }, value: har }))) : null)
  );
}
...
import { Box as Box17 } from "@mui/system";
import * as React67 from "react";

// src/toolpad/AppEditor/PageEditor/ErrorAlert.tsx
import * as React66 from "react";
import { Alert as Alert4, AlertTitle, IconButton as IconButton11, Collapse as Collapse2, Box as Box16 } from "@mui/material";
import ExpandLessIcon from "@mui/icons-material/ExpandLess";
import ExpandMoreIcon from "@mui/icons-material/ExpandMore";
import { indent } from "@toolpad/utils/strings";

// src/components/Pre.tsx
import { styled as styled22 } from "@mui/material";
var Pre = styled22("pre")({
  margin: 0,
  fontFamily: 'Consolas, Menlo, Monaco, "Andale Mono", "Ubuntu Mono", monospace'
});
var Pre_default = Pre;
...
function ErrorAlert({ error, sx }) {
  ...
  const [expanded, setExpanded] = React66.useState(false);
  const toggleExpanded = React66.useCallback(() => setExpanded((actual) => !actual), []);
  return /* @__PURE__ */ React66.createElement(Alert4, { severity: "error", sx: { ...sx, position: "relative" } }, stack ? /* @__PURE__ */ React66.createElement(
    IconButton11,
    {
      color: "inherit",
    ...
    expanded ? /* @__PURE__ */ React66.createElement(ExpandLessIcon, null) : /* @__PURE__ */ React66.createElement(ExpandMoreIcon, null)
  ) : null, /* @__PURE__ */ React66.createElement(AlertTitle, null, /* @__PURE__ */ React66.createElement(Pre_default, { sx: { whiteSpace: "pre-wrap" } }, message)), stack ? /* @__PURE__ */ React66.createElement(Collapse2, { in: expanded }, /* @__PURE__ */ React66.createElement(Box16, { sx: { overflow: "auto" } }, /* @__PURE__ */ React66.createElement(Pre_default, null, stack))) : null);
}
...
function QueryPreview({ children, error, isLoading }) {
  return /* @__PURE__ */ React67.createElement(
    ...
    isLoading ? /* @__PURE__ */ React67.createElement(LinearProgress2, null) : null,
    /* @__PURE__ */ React67.createElement(Box17, { sx: { flex: 1, minHeight: 0, overflow: "auto" } }, error ? /* @__PURE__ */ React67.createElement(ErrorAlert, { sx: { m: 2 }, error }) : children)
  );
}
...
var ButtonLink = styled23("button")(({ theme }) => ({
  background: "none",
  border: "none",
  fontSize: "inherit",
  padding: 0,
...
function UrlControl({ label, disabled, baseUrl, value, onChange }) {
  ...
  return /* @__PURE__ */ React68.createElement(
    TextField15,
    {
      ...
      label,
      InputProps: baseUrl ? {
        startAdornment: /* @__PURE__ */ React68.createElement(InputAdornment3, { position: "start" }, baseUrl)
      } : void 0
    }
  );
}
...
function ConnectionParamsInput({ value, onChange }) {
  ...
  React68.useEffect(() => reset(withDefaults(value)), [reset, value]);
  ...
  return /* @__PURE__ */ React68.createElement(Stack9, { direction: "column", gap: 3, sx: { py: 3 } }, /* @__PURE__ */ React68.createElement(TextField15, { ...baseUrlInputProps }), /* @__PURE__ */ React68.createElement(Typography12, null, "Headers:"), /* @__PURE__ */ React68.createElement(
    Controller,
    {
      name: "headers",
      control,
  ...
  ), /* @__PURE__ */ React68.createElement(Typography12, null, "Authentication:"), /* @__PURE__ */ React68.createElement(
    Controller,
    {
      name: "authentication",
      control,
      render: ({ field: { value: fieldValue, ref, ...field } }) => /* @__PURE__ */ React68.createElement(AuthenticationEditor, { ...field, disabled: !headersAllowed, value: fieldValue ?? null })
    }
  ), /* @__PURE__ */ React68.createElement(Toolbar3, { disableGutters: true }, /* @__PURE__ */ React68.createElement(Box18, { sx: { flex: 1 } }), /* @__PURE__ */ React68.createElement(Button8, { variant: "contained", onClick: doSubmit, disabled: isSaveDisabled(formState) }, "Save")));
}
function ResolvedPreview({
  ...
  if (!preview) {
    return /* @__PURE__ */ React68.createElement(
      ...
      /* @__PURE__ */ React68.createElement("br", null),
      "Click Run",
  ...
  if (typeof data === "undefined" && typeof untransformedData !== "undefined") {
    alert = /* @__PURE__ */ React68.createElement(Alert5, { severity: "warning", sx: { m: 1, p: 1, fontSize: 11 } }, /* @__PURE__ */ React68.createElement(Box18, { sx: { mb: 1 } }, "Request successfully completed and returned data", responseDataKeys.length > 0 ? " with the following keys:" : "."), responseDataKeys.map((key) => /* @__PURE__ */ React68.createElement(Box18, { sx: { display: "block" }, key }, "- ", key)), /* @__PURE__ */ React68.createElement(Box18, { sx: { mt: 1 } }, "However, it seems that the ", /* @__PURE__ */ React68.createElement(ButtonLink, { onClick: onShowTransform }, "transform"), " ", "function returned an ", /* @__PURE__ */ React68.createElement("code", null, "undefined"), " value."));
  }
  return /* @__PURE__ */ React68.createElement(React68.Fragment, null, alert, /* @__PURE__ */ React68.createElement(JsonView, { sx: { height: "100%" }, src: preview?.data }));
}
var EMPTY_PARAMS = [];
function QueryEditor({
  ...
  const updateProp = React68.useCallback(
  ...
  const env = React68.useMemo(() => introspection?.data?.env ?? {}, [introspection?.data?.env]);
  const declaredEnvKeys = React68.useMemo(
    () => introspection?.data?.declaredEnvKeys ?? [],
    [introspection?.data?.declaredEnvKeys]
  );
  const handleParamsChange = React68.useCallback(
    (newParams) => {
      appStateApi.updateQueryDraft((draft) => ({
        ...draft,
        params: newParams
  ...
  const handleUrlChange = React68.useCallback(
    (newUrl) => {
      updateProp("url", newUrl ?? "");
    },
    [updateProp]
  );
  const handleMethodChange = React68.useCallback(
    (event) => {
      updateProp("method", event.target.value);
    },
    [updateProp]
  );
  const handleTransformEnabledChange = React68.useCallback(
    (transformEnabled) => {
      updateProp("transformEnabled", transformEnabled);
    },
    [updateProp]
  );
  const handleTransformChange = React68.useCallback(
    (transform) => {
      updateProp("transform", transform);
    },
    [updateProp]
  );
  const handleBodyChange = React68.useCallback(
    (newBody) => {
      updateProp("body", newBody || void 0);
    },
    [updateProp]
  );
  const handleSearchParamsChange = React68.useCallback(
    (newSearchParams) => {
      updateProp("searchParams", newSearchParams);
    },
    [updateProp]
  );
  const handleHeadersChange = React68.useCallback(
    (newHeaders) => {
      updateProp("headers", newHeaders);
    },
    [updateProp]
  );
  const handleResponseTypeChange = React68.useCallback(
    (event) => {
      updateProp("response", {
  ...
  const jsServerRuntime = React68.useMemo(() => createServerJsRuntime(env ?? {}), [env]);
  const paramsEditorLiveValue = useEvaluateLiveBindingEntries({
    jsRuntime: jsServerRuntime,
    input: paramsEntries,
    globalScope
  });
  const previewParams = React68.useMemo(
    () => Object.fromEntries(paramsEditorLiveValue.map(([key, binding]) => [key, binding?.value])),
    [paramsEditorLiveValue]
  );
  const queryScope = React68.useMemo(
    () => ({
  ...
  const [configTab, setConfigTab] = React68.useState("urlQuery");
  const currentTab = React68.useMemo(() => {
  ...
  const handleToolsTabTypeChange = React68.useCallback(
    (value) => {
  ...
  const fetchPreview = React68.useCallback(
    (query, params) => fetchPrivate({ kind: "debugExec", query, params }),
    [fetchPrivate]
  );
  const [previewHar, setPreviewHar] = React68.useState(() => createHarLog());
  const { preview, runPreview, isLoading } = useQueryPreview(
    fetchPreview,
    input.attributes.query,
    previewParams,
    {
      onPreview: React68.useCallback((result) => {
        setPreviewHar(
  ...
  const handleHarClear = React68.useCallback(() => setPreviewHar(createHarLog()), []);
  const handleConfigTabChange = React68.useCallback(
    (event, newValue) => setConfigTab(newValue),
    []
  );
  const handleTabTypeChange = React68.useCallback(
    (event, value) => {
      appStateApi.updateQueryTab((tab) => ({
        ...tab,
        tabType: value
  ...
  return currentTab ? /* @__PURE__ */ React68.createElement(resizablePanels_exports.PanelGroup, { autoSaveId: "toolpad/rest-panel", direction: "horizontal" }, /* @__PURE__ */ React68.createElement(resizablePanels_exports.Panel, { id: "rest-query-left", defaultSize: 50, minSize: 40, style: { overflow: "auto" } }, /* @__PURE__ */ React68.createElement(TabContext5, { value: currentTab?.tabType ?? "config" }, /* @__PURE__ */ React68.createElement(Stack9, { direction: "column", gap: 0 }, /* @__PURE__ */ React68.createElement(
    Stack9,
    {
      direction: "row",
      sx: {
    ...
    /* @__PURE__ */ React68.createElement(
      ...
      /* @__PURE__ */ React68.createElement(Tab4, { label: "Config", value: "config" }),
      /* @__PURE__ */ React68.createElement(Tab4, { label: "Settings", value: "settings" })
    ),
    /* @__PURE__ */ React68.createElement(
      HelpTooltipIcon,
      {
        helpText: /* @__PURE__ */ React68.createElement(Typography12, { variant: "inherit" }, "To configure a HTTP request, check out the", " ", /* @__PURE__ */ React68.createElement(
          Link7,
          {
  ...
  ), /* @__PURE__ */ React68.createElement(Divider6, null), /* @__PURE__ */ React68.createElement(TabPanel_default, { value: "config", disableGutters: true }, /* @__PURE__ */ React68.createElement(React68.Fragment, null, /* @__PURE__ */ React68.createElement(
    Box18,
    {
      sx: {
        display: "grid",
    ...
    /* @__PURE__ */ React68.createElement(
      ...
      HTTP_METHODS.map((method) => /* @__PURE__ */ React68.createElement(MenuItem5, { key: method, value: method }, method))
    ),
    /* @__PURE__ */ React68.createElement(
      BindableEditor,
      {
        ...
        label: "url",
        propType: { type: "string" },
        renderControl: (props) => /* @__PURE__ */ React68.createElement(UrlControl, { baseUrl, ...props }),
        value: urlValue,
        onChange: handleUrlChange
      }
    )
  ), /* @__PURE__ */ React68.createElement(Box18, { sx: { display: "flex", flexDirection: "column", gap: 1, mt: 2.5, mx: 0 } }, /* @__PURE__ */ React68.createElement(TabContext5, { value: configTab }, /* @__PURE__ */ React68.createElement(Box18, { sx: { border: 1, borderColor: "divider" } }, /* @__PURE__ */ React68.createElement(
    TabList4,
    {
      sx: { "& button": { fontSize: 12, fontWeight: "normal" } },
    ...
    /* @__PURE__ */ React68.createElement(Tab4, { label: "URL query", value: "urlQuery" }),
    /* @__PURE__ */ React68.createElement(Tab4, { label: "Body", value: "body" }),
    /* @__PURE__ */ React68.createElement(Tab4, { label: "Headers", value: "headers" }),
    /* @__PURE__ */ React68.createElement(Tab4, { label: "Response", value: "response" }),
    /* @__PURE__ */ React68.createElement(Tab4, { label: "Transform", value: "transform" })
  )), /* @__PURE__ */ React68.createElement(TabPanel_default, { disableGutters: true, value: "urlQuery", sx: { ml: 1 } }, /* @__PURE__ */ React68.createElement(
    ParametersEditor,
    {
  ...
  )), /* @__PURE__ */ React68.createElement(TabPanel_default, { disableGutters: true, value: "body", sx: { ml: 1 } }, /* @__PURE__ */ React68.createElement(
    BodyEditor,
    {
  ...
  )), /* @__PURE__ */ React68.createElement(TabPanel_default, { disableGutters: true, value: "headers", sx: { ml: 1 } }, /* @__PURE__ */ React68.createElement(
    ParametersEditor,
    {
  ...
  )), /* @__PURE__ */ React68.createElement(TabPanel_default, { disableGutters: true, value: "response", sx: { ml: 1 } }, /* @__PURE__ */ React68.createElement(
    TextField15,
    {
      select: true,
      label: "response type",
    ...
    /* @__PURE__ */ React68.createElement(MenuItem5, { value: "raw" }, "raw"),
    /* @__PURE__ */ React68.createElement(MenuItem5, { value: "json" }, "JSON"),
    /* @__PURE__ */ React68.createElement(MenuItem5, { value: "csv", disabled: true }, "\u{1F6A7} CSV"),
    /* @__PURE__ */ React68.createElement(MenuItem5, { value: "xml", disabled: true }, "\u{1F6A7} XML")
  )), /* @__PURE__ */ React68.createElement(TabPanel_default, { disableGutters: true, value: "transform", sx: { ml: 1 } }, /* @__PURE__ */ React68.createElement(
    TransformInput,
    {
  ...
  )))))), /* @__PURE__ */ React68.createElement(TabPanel_default, { value: "settings", disableGutters: true }, settingsTab)))), /* @__PURE__ */ React68.createElement(PanelResizeHandle, null), /* @__PURE__ */ React68.createElement(resizablePanels_exports.Panel, { id: "rest-query-right", defaultSize: 50, minSize: 20 }, /* @__PURE__ */ React68.createElement(resizablePanels_exports.PanelGroup, { autoSaveId: "toolpad/rest/params-tools-split", direction: "vertical" }, /* @__PURE__ */ React68.createElement(resizablePanels_exports.Panel, { defaultSize: 50, style: { overflow: "auto", scrollbarGutter: "stable" } }, /* @__PURE__ */ React68.createElement(Box18, { display: "flex", flexDirection: "column" }, /* @__PURE__ */ React68.createElement(TabContext5, { value: "parameters" }, /* @__PURE__ */ React68.createElement(
    TabList4,
    {
      sx: {
    ...
    /* @__PURE__ */ React68.createElement(Tab4, { label: "Parameters", value: "parameters" })
  ), /* @__PURE__ */ React68.createElement(Divider6, { sx: { mb: 1.5 } }), /* @__PURE__ */ React68.createElement(TabPanel_default, { value: "parameters", disableGutters: true, sx: { ml: 1 } }, /* @__PURE__ */ React68.createElement(
    ParametersEditor,
    {
      value: paramsEntries,
      onChange: handleParamsChange,
  ...
  ))))), /* @__PURE__ */ React68.createElement(PanelResizeHandle, null), /* @__PURE__ */ React68.createElement(resizablePanels_exports.Panel, { defaultSize: 50, style: { overflow: "auto", scrollbarGutter: "stable" } }, /* @__PURE__ */ React68.createElement(TabContext5, { value: currentTab.toolsTabType }, /* @__PURE__ */ React68.createElement(
    Box18,
    {
      sx: {
        borderBottom: 1,
    ...
    /* @__PURE__ */ React68.createElement(
      ...
      /* @__PURE__ */ React68.createElement(Tab4, { label: "Preview", value: "preview" }),
      /* @__PURE__ */ React68.createElement(Tab4, { label: "Dev Tools", value: "devTools" })
    ),
    /* @__PURE__ */ React68.createElement(
      LoadingButton2,
      {
        ...
        disabled: isLoading,
        onClick: runPreview,
        endIcon: /* @__PURE__ */ React68.createElement(PlayArrowIcon, { "aria-label": "Run preview", onClick: runPreview })
      },
      "Run"
    )
  ), /* @__PURE__ */ React68.createElement(TabPanel_default, { value: "preview", disableGutters: true }, /* @__PURE__ */ React68.createElement(QueryPreview, { isLoading: currentTab.isPreviewLoading, error: preview?.error }, /* @__PURE__ */ React68.createElement(
    ResolvedPreview,
    {
      preview,
      onShowTransform: () => setConfigTab("transform")
    }
  ))), /* @__PURE__ */ React68.createElement(TabPanel_default, { value: "devTools", disableGutters: true }, /* @__PURE__ */ React68.createElement(Devtools, { sx: { overflow: "auto" }, har: previewHar, onHarClear: handleHarClear }))))))) : /* @__PURE__ */ React68.createElement(Alert5, { severity: "error" }, "An error occurred while rendering this tab. Please refresh and try again.");
}
...
var StyledAutocompletePopper = styled24("div")(({ theme }) => ({
...
function PopperComponent(props) {
  ...
  return /* @__PURE__ */ React69.createElement(StyledAutocompletePopper, { ...other });
}
var StyledPopper = styled24(Popper)(({ theme }) => ({
  border: `1px solid ${theme.palette.divider}`,
...
var StyledInput = styled24(InputBase)(({ theme }) => ({
  padding: 10,
  width: "100%",
  border: `1px solid ${theme.palette.divider}`,
  "& input": {
...
var FunctionButton = styled24(Chip2)(({ theme }) => ({
  fontSize: 12,
  width: "100%",
...
var StyledListSubheader = styled24(ListSubheader)(({ theme }) => ({
  lineHeight: 2.5,
  fontSize: 13,
  fontFamily: theme.typography.fontFamilyCode,
...
function FunctionSelector({
  ...
  const { selectedFileName, selectedFunctionName } = React69.useMemo(() => {
  ...
  const handleCreateNew = React69.useCallback(async () => {
    const functionId = await onCreateNew();
    onSelect(functionId);
  }, [onCreateNew, onSelect]);
  const handleInput = React69.useCallback((event) => {
  ...
  return /* @__PURE__ */ React69.createElement(React69.Fragment, null, /* @__PURE__ */ React69.createElement(
    FunctionButton,
    {
      "aria-describedby": id,
      clickable: true,
      icon: /* @__PURE__ */ React69.createElement(DataObjectOutlinedIcon, { fontSize: "inherit", color: "inherit" }),
      onClick: handleClick,
    ...
    /* @__PURE__ */ React69.createElement(ClickAwayListener, { onClickAway: handleClose }, /* @__PURE__ */ React69.createElement("div", null, /* @__PURE__ */ React69.createElement(
      Box19,
      {
        sx: {
          px: 1,
      ...
      Autocomplete3,
      {
        ...
        renderGroup: (params) => [
          /* @__PURE__ */ React69.createElement(StyledListSubheader, { key: params.key }, /* @__PURE__ */ React69.createElement(Stack10, { direction: "row", justifyContent: "space-between" }, params.group, /* @__PURE__ */ React69.createElement(
            OpenCodeEditorButton,
            {
        ...
        renderOption: (props, option, { selected }) => /* @__PURE__ */ React69.createElement("li", { ...props }, /* @__PURE__ */ React69.createElement(
          Box19,
          {
            component: DoneIcon,
            sx: {
        ...
        renderInput: (params) => /* @__PURE__ */ React69.createElement(
          StyledInput,
          {
      ...
      {
        sx: { m: 1, mb: 0.5 },
        startIcon: /* @__PURE__ */ React69.createElement(AddOutlinedIcon, { fontSize: "inherit" }),
...
function ResolvedPreview2({ preview }) {
  if (!preview) {
    return /* @__PURE__ */ React70.createElement(
      ...
      "No request has been sent yet. ",
      /* @__PURE__ */ React70.createElement("br", null),
      "Click Run",
  ...
  const { data } = preview;
  return /* @__PURE__ */ React70.createElement(JsonView, { sx: { height: "100%" }, src: data, copyToClipboard: true });
}
function QueryEditor2({
  ...
  const updateProp = React70.useCallback(
    function updateProp2(prop, value) {
      appStateApi.updateQueryDraft((draft) => ({
        ...draft,
        attributes: {
  ...
  const currentTab = React70.useMemo(() => {
    if (currentView.kind === "page" && currentView.view?.kind === "query" && currentView.queryPanel?.currentTabIndex !== void 0) {
      return currentView.queryPanel?.queryTabs?.[currentView.queryPanel?.currentTabIndex];
    }
    return null;
  ...
  const selectedOption = React70.useMemo(() => {
  ...
  const parameterDefs = React70.useMemo(
    () => Object.fromEntries(selectedOption?.parameters || []),
    [selectedOption?.parameters]
  );
  const paramsEntries = React70.useMemo(
  ...
  const previewParams = React70.useMemo(
    () => Object.fromEntries(paramsEditorLiveValue.map(([key, binding]) => [key, binding?.value])),
    [paramsEditorLiveValue]
  );
  const handleToolsTabTypeChange = React70.useCallback(
    (value) => {
      appStateApi.updateQueryTab((tab) => ({
        ...tab,
        toolsTabType: value
  ...
  const fetchServerPreview = React70.useCallback(
    async (query, params) => {
  ...
  const handleRunPreview = React70.useCallback(() => {
    runPreview();
  }, [runPreview]);
  React70.useEffect(() => {
    appStateApi.updateQueryTab((tab) => ({
  ...
  const handleSelectFunction = React70.useCallback(
    (functionId) => {
      updateProp("function", functionId);
    },
    [updateProp]
  );
  const proposedFileName = React70.useMemo(() => {
  ...
  const handleCreateNewCommit = React70.useCallback(async () => {
    try {
  ...
  const handleTabTypeChange = React70.useCallback(
    (value) => {
      appStateApi.updateQueryTab((tab) => ({
        ...tab,
        tabType: value
  ...
  return currentTab ? /* @__PURE__ */ React70.createElement(resizablePanels_exports.PanelGroup, { autoSaveId: "toolpad/local-panel", direction: "horizontal" }, /* @__PURE__ */ React70.createElement(
    ...
    /* @__PURE__ */ React70.createElement(TabContext6, { value: currentTab?.tabType ?? "config" }, /* @__PURE__ */ React70.createElement(Stack11, { direction: "column", gap: 0 }, /* @__PURE__ */ React70.createElement(
      Stack11,
      {
        direction: "row",
        sx: {
      ...
      /* @__PURE__ */ React70.createElement(
        ...
        /* @__PURE__ */ React70.createElement(Tab5, { label: "Config", value: "config" }),
        /* @__PURE__ */ React70.createElement(Tab5, { label: "Settings", value: "settings" })
      ),
      /* @__PURE__ */ React70.createElement(
        HelpTooltipIcon,
        {
          helpText: /* @__PURE__ */ React70.createElement(Typography13, { variant: "inherit" }, "To configure a custom function, check out the", " ", /* @__PURE__ */ React70.createElement(
            Link8,
            {
    ...
    ), /* @__PURE__ */ React70.createElement(Divider7, null), /* @__PURE__ */ React70.createElement(TabPanel_default, { value: "config", disableGutters: true }, /* @__PURE__ */ React70.createElement(
      Stack11,
      {
        display: "flex",
        flexDirection: "row",
      ...
      introspection.error ? /* @__PURE__ */ React70.createElement(
        Box20,
        {
          sx: {
            position: "absolute",
    ...
    )), /* @__PURE__ */ React70.createElement(TabPanel_default, { value: "settings", disableGutters: true }, settingsTab)))
  ), /* @__PURE__ */ React70.createElement(PanelResizeHandle, null), /* @__PURE__ */ React70.createElement(resizablePanels_exports.Panel, { id: "local-query-right", defaultSize: 50, minSize: 20 }, /* @__PURE__ */ React70.createElement(resizablePanels_exports.PanelGroup, { autoSaveId: "toolpad/local/params-tools-split", direction: "vertical" }, /* @__PURE__ */ React70.createElement(
    resizablePanels_exports.Panel,
    {
    ...
    /* @__PURE__ */ React70.createElement(Box20, { display: "flex", flexDirection: "column" }, /* @__PURE__ */ React70.createElement(TabContext6, { value: "parameters" }, /* @__PURE__ */ React70.createElement(
      TabList5,
      {
        sx: {
          "& button": { fontSize: 12, fontWeight: "normal", cursor: "default" }
      ...
      /* @__PURE__ */ React70.createElement(Tab5, { label: "Parameters", value: "parameters" })
    ), /* @__PURE__ */ React70.createElement(Divider7, { sx: { mb: 1.5 } }), /* @__PURE__ */ React70.createElement(TabPanel_default, { value: "parameters", disableGutters: true, sx: { ml: 1 } }, /* @__PURE__ */ React70.createElement(Grid22, { display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 2 }, Object.entries(parameterDefs).map(([name, definiton]) => {
      const Control = getDefaultControl(propTypeControls, definiton, liveBindings);
      return Control ? /* @__PURE__ */ React70.createElement(
        BindableEditor,
        {
          key: name,
          ...
          propType: definiton,
          jsRuntime: jsBrowserRuntime,
          renderControl: (renderControlParams) => /* @__PURE__ */ React70.createElement(Control, { ...renderControlParams, propType: definiton }),
  ...
  ), /* @__PURE__ */ React70.createElement(PanelResizeHandle, null), /* @__PURE__ */ React70.createElement(
    resizablePanels_exports.Panel,
    {
      id: "preview",
      defaultSize: 50,
    ...
    /* @__PURE__ */ React70.createElement(TabContext6, { value: currentTab.toolsTabType }, /* @__PURE__ */ React70.createElement(
      Box20,
      {
        sx: {
          borderBottom: 1,
      ...
      /* @__PURE__ */ React70.createElement(
        ...
        /* @__PURE__ */ React70.createElement(Tab5, { label: "Preview", value: "preview" })
      ),
      /* @__PURE__ */ React70.createElement(
        LoadingButton3,
        {
          ...
          disabled: isLoading,
          onClick: runPreview,
          endIcon: /* @__PURE__ */ React70.createElement(PlayArrowIcon2, { "aria-label": "Run preview", onClick: runPreview })
        },
        "Run"
      )
    ), /* @__PURE__ */ React70.createElement(TabPanel_default, { value: "preview", disableGutters: true }, /* @__PURE__ */ React70.createElement(QueryPreview, { isLoading: currentTab.isPreviewLoading, error: preview?.error }, /* @__PURE__ */ React70.createElement(ResolvedPreview2, { preview }))))
  )))) : /* @__PURE__ */ React70.createElement(Alert6, { severity: "error" }, "An error occurred while rendering this tab. Please refresh and try again.");
}
...
function QuerySettingsTab({
  ...
  const appStateApi = useAppStateApi();
  const updateAttribute = React71.useCallback(
  ...
  const handleModeChange = React71.useCallback(
    (event) => {
  ...
  const handleEnabledChange = React71.useCallback(
    (newValue) => {
      if (newValue !== null) {
  ...
  const handleRefetchIntervalChange = React71.useCallback(
    (event) => {
  ...
  return /* @__PURE__ */ React71.createElement(
    ...
    /* @__PURE__ */ React71.createElement(
      ...
      /* @__PURE__ */ React71.createElement(Typography14, { fontSize: 12, sx: { alignSelf: "center" } }, "Set query mode:"),
      /* @__PURE__ */ React71.createElement(
        TextField16,
        {
          select: true,
        ...
        /* @__PURE__ */ React71.createElement(MenuItem6, { value: "query" }, "Fetch at any time to always be available on the page"),
        /* @__PURE__ */ React71.createElement(MenuItem6, { value: "mutation" }, "Only fetch on manual action")
      ),
      draft?.attributes?.mode !== "mutation" ? /* @__PURE__ */ React71.createElement(React71.Fragment, null, /* @__PURE__ */ React71.createElement(Typography14, { fontSize: 12, sx: { alignSelf: "center" } }, "Set refetch interval:"), /* @__PURE__ */ React71.createElement(
        TextField16,
        {
          InputProps: {
            startAdornment: /* @__PURE__ */ React71.createElement(InputAdornment4, { position: "start" }, "s")
          },
          sx: {
            [`& .${inputLabelClasses4.root}`]: { fontSize: 12 },
            [`& .${inputBaseClasses4.root}`]: { fontSize: 12 },
      ...
      ), /* @__PURE__ */ React71.createElement(Typography14, { fontSize: 12, sx: { alignSelf: "center" } }, "Set query enabled/disabled:"), /* @__PURE__ */ React71.createElement(
        BindableEditor,
        {
...
function QueryEditorPanel({ draft, saved }) {
  ...
  const queryEditorContext = React71.useMemo(
  ...
  const execPrivate = React71.useCallback(
    (method, args) => {
  ...
  return dataSourceId && dataSource3 && queryEditorContext ? /* @__PURE__ */ React71.createElement(ConnectionContextProvider, { value: queryEditorContext }, /* @__PURE__ */ React71.createElement(Box21, { sx: { height: "100%", p: 0, overflow: "hidden" } }, /* @__PURE__ */ React71.createElement(
    dataSource3.QueryEditor,
    {
      ...
      globalScopeMeta,
      execApi: execPrivate,
      settingsTab: /* @__PURE__ */ React71.createElement(
        QuerySettingsTab,
        {
          ...{
            draft,
  ...
  ))) : /* @__PURE__ */ React71.createElement(Alert7, { severity: "error" }, 'Datasource "', dataSourceId, '" not found');
}
...
function getModifierKey() {
  return isMac() ? "\u2318" : /* @__PURE__ */ React72.createElement("kbd", null, "Ctrl");
}

// src/toolpad/AppEditor/PageEditor/QueryEditor/index.tsx
function SaveShortcutIndicator() {
  return /* @__PURE__ */ React73.createElement("span", null, getModifierKey(), "+", /* @__PURE__ */ React73.createElement("kbd", null, "S"));
}
function TabCloseIcon({
  ...
  const appStateApi = useAppStateApi();
  const [notHovered, setNotHovered] = React73.useState(true);
  const onClose = React73.useCallback(() => {
    if (queryId === void 0) {
      return;
    }
  ...
  return unsaved && notHovered ? /* @__PURE__ */ React73.createElement(
    CircleIcon,
    {
...
function QueryEditor3() {
  ...
  const hasUnsavedChanges = React73.useCallback(
    (queryIndex) => {
  ...
  const handleSave = React73.useCallback(() => {
  ...
  const onClosePanel = React73.useCallback(() => {
    appStateApi.closeQueryPanel();
  }, [appStateApi]);
  const saveDisabled = React73.useMemo(
    () => !hasUnsavedChanges(Number(currentTabIndex)),
    [hasUnsavedChanges, currentTabIndex]
  );
  const hasUnsavedChangesInPanel = React73.useMemo(() => {
  ...
  return currentView.kind === "page" && currentView.view?.kind === "query" && currentQueryId && currentView?.queryPanel?.queryTabs ? /* @__PURE__ */ React73.createElement(
    Stack13,
    {
      direction: "column",
    ...
    /* @__PURE__ */ React73.createElement(TabContext7, { value: currentTabIndex }, /* @__PURE__ */ React73.createElement(
      Stack13,
      {
        direction: "row",
        justifyContent: "space-between",
      ...
      /* @__PURE__ */ React73.createElement(TabList6, { onChange: handleTabChange, "aria-label": "Query editor tabs" }, currentView.queryPanel?.queryTabs?.map((query, index) => /* @__PURE__ */ React73.createElement(
        Tab6,
        {
          key: index,
          label: /* @__PURE__ */ React73.createElement(
            Chip3,
            {
              ...
              deleteIcon: /* @__PURE__ */ React73.createElement(
                TabCloseIcon,
                {
                  queryIndex: index,
          ...
          icon: /* @__PURE__ */ React73.createElement(
            QueryIcon,
            {
      ...
      /* @__PURE__ */ React73.createElement("div", null, /* @__PURE__ */ React73.createElement(
        ...
        "Save \xA0",
        /* @__PURE__ */ React73.createElement(SaveShortcutIndicator, null)
      ), /* @__PURE__ */ React73.createElement(IconButton12, { size: "small", disableRipple: true, onClick: handleClosePanel }, /* @__PURE__ */ React73.createElement(
      ...
      if (query && query.draft) {
        return /* @__PURE__ */ React73.createElement(
          ...
          /* @__PURE__ */ React73.createElement(React73.Suspense, { fallback: /* @__PURE__ */ React73.createElement(LinearProgress3, null) }, /* @__PURE__ */ React73.createElement(QueryEditorPanel, { draft: query.draft, saved: query.saved }))
        );
      }
      return null;
    }))
...
var PageEditorRoot = styled25("div")({
  width: "100%",
  height: "100%",
  overflow: "hidden",
  display: "flex",
...
function PageEditorContent({ node }) {
  ...
  return /* @__PURE__ */ React74.createElement(PageEditorProvider, { key: node.id, nodeId: node.id }, /* @__PURE__ */ React74.createElement(resizablePanels_exports.PanelGroup, { autoSaveId: "toolpad/editor-panel-split", direction: "vertical" }, /* @__PURE__ */ React74.createElement(resizablePanels_exports.Panel, { order: 1, id: "editor" }, /* @__PURE__ */ React74.createElement(resizablePanels_exports.PanelGroup, { autoSaveId: "editor/component-panel-split", direction: "horizontal" }, /* @__PURE__ */ React74.createElement(resizablePanels_exports.Panel, { id: "page-editor", defaultSize: 75, minSize: 50, maxSize: 80 }, /* @__PURE__ */ React74.createElement(PageEditorRoot, null, /* @__PURE__ */ React74.createElement(ComponentCatalog_default, null), /* @__PURE__ */ React74.createElement(RenderPanel_default, { className: classes6.renderPanel }))), /* @__PURE__ */ React74.createElement(PanelResizeHandle, null), /* @__PURE__ */ React74.createElement(resizablePanels_exports.Panel, { id: "component-panel", defaultSize: 25, maxSize: 50, minSize: 20 }, /* @__PURE__ */ React74.createElement(ComponentPanel, null)))), /* @__PURE__ */ React74.createElement(PanelResizeHandle, null), showQuery ? /* @__PURE__ */ React74.createElement(resizablePanels_exports.Panel, { minSize: 10, maxSize: 90, defaultSize: 35, order: 2, id: "query-panel" }, /* @__PURE__ */ React74.createElement(QueryEditor3, null)) : null));
}
function PageEditor({ name }) {
  const { dom } = useAppState();
  const pageNode = React74.useMemo(() => appDom21.getPageByName(dom, name), [dom, name]);
  useUndoRedo();
  return pageNode ? /* @__PURE__ */ React74.createElement(PageEditorContent, { node: pageNode }) : /* @__PURE__ */ React74.createElement(NotFoundEditor, { message: `Non-existing Page "${name}"` });
}
...
import { styled as styled30, Box as Box25, Divider as Divider9, Typography as Typography19 } from "@mui/material";
import * as appDom26 from "@toolpad/studio-runtime/appDom";

// src/toolpad/AppEditor/PagesExplorer/index.tsx
import * as React80 from "react";
import { styled as styled27, Box as Box22, IconButton as IconButton14, Stack as Stack15, Tooltip as Tooltip12 } from "@mui/material";
...
var SystemDialogCancelButton = React75.forwardRef(
  ({ children = "cancel", ...props }, ref) => /* @__PURE__ */ React75.createElement(Button10, { ref, color: "inherit", variant: "text", ...props }, children)
);
var SystemDialogOkButton = React75.forwardRef(
  ({ children = "ok", ...props }, ref) => /* @__PURE__ */ React75.createElement(LoadingButton5, { ref, ...props }, children)
);
function ConfirmDialog({
  ...
  const handleCancel = React75.useCallback(
    (event) => onClose(false, event),
    [onClose]
  );
  const handleOk = React75.useCallback((event) => onClose(true, event), [onClose]);
  return /* @__PURE__ */ React75.createElement(SystemDialog, { open, onClose: handleCancel }, /* @__PURE__ */ React75.createElement(SystemDialogTitle, null, title ?? "Confirm"), /* @__PURE__ */ React75.createElement(SystemDialogContent, null, children), /* @__PURE__ */ React75.createElement(SystemDialogActions, null, /* @__PURE__ */ React75.createElement(SystemDialogCancelButton, { onClick: handleCancel }, cancelButton), /* @__PURE__ */ React75.createElement(SystemDialogOkButton, { color: severity, loading, onClick: handleOk }, okButton)));
}

// src/utils/useMenu.ts
import * as React76 from "react";
function useMenu() {
  const buttonId = React76.useId();
  const menuId = React76.useId();
  const [anchorEl, setAnchorEl] = React76.useState(null);
  const open = Boolean(anchorEl);
  const onMenuClose = React76.useCallback((event) => {
    event?.stopPropagation?.();
    setAnchorEl(null);
  }, []);
  const buttonProps = React76.useMemo(
    () => ({
      id: buttonId,
  ...
  const menuProps = React76.useMemo(
    () => ({
      id: menuId,
      anchorEl,
      open,
...
function NodeMenu({
  ...
  const [deletedNodeId, setDeletedNodeId] = React77.useState(null);
  const handleDeleteNodeDialogOpen = React77.useCallback(
    (event) => {
      event.stopPropagation();
  ...
  const isAction = React77.useMemo(() => {
    if (latestDeletedNode?.type === "query" && latestDeletedNode?.attributes?.mode === "mutation") {
      return true;
    }
    return false;
  }, [latestDeletedNode]);
  const handleDeleteNodeDialogClose = React77.useCallback(
    (confirmed, event) => {
      event.stopPropagation();
  ...
  const handleRenameClick = React77.useCallback(
    (event) => {
      onRenameNode?.(nodeId);
      onMenuClose(event);
    },
  ...
  const handleDuplicateClick = React77.useCallback(
    (event) => {
      onMenuClose(event);
  ...
  return /* @__PURE__ */ React77.createElement(React77.Fragment, null, renderButton({
    buttonProps,
    menuProps
    ...
    onRenameNode ? /* @__PURE__ */ React77.createElement(MenuItem7, { onClick: handleRenameClick }, /* @__PURE__ */ React77.createElement(ListItemIcon, null, /* @__PURE__ */ React77.createElement(ModeEditIcon, null)), /* @__PURE__ */ React77.createElement(ListItemText, null, renameLabelText)) : null,
    onDuplicateNode ? /* @__PURE__ */ React77.createElement(MenuItem7, { onClick: handleDuplicateClick }, /* @__PURE__ */ React77.createElement(ListItemIcon, null, /* @__PURE__ */ React77.createElement(ContentCopyIcon2, null)), /* @__PURE__ */ React77.createElement(ListItemText, null, duplicateLabelText)) : null,
    onDeleteNode ? /* @__PURE__ */ React77.createElement(MenuItem7, { onClick: handleDeleteNodeDialogOpen }, /* @__PURE__ */ React77.createElement(ListItemIcon, null, /* @__PURE__ */ React77.createElement(DeleteIcon4, null)), /* @__PURE__ */ React77.createElement(ListItemText, null, deleteLabelText)) : null
  ), /* @__PURE__ */ React77.createElement(
    ConfirmDialog,
    {
      open: !!deletedNode,
...
function EditableTreeItem({
  ...
  const [itemNameInput, setItemNameInput] = React78.useState(suggestedNewItemName);
  const [isInternalEditing, setIsInternalEditing] = React78.useState(false);
  const isEditing = isExternalEditing || isInternalEditing;
  const newItemValidationResult = React78.useMemo(
  ...
  const handleConfirm = React78.useCallback(async () => {
  ...
  const handleChange = React78.useCallback((event) => {
    setItemNameInput(event.target.value.replaceAll(/[^a-zA-Z0-9]/g, ""));
  }, []);
  const handleFocus = React78.useCallback((event) => {
    event.target.select();
    event.stopPropagation();
  }, []);
  const handleBlur = React78.useCallback(() => {
    handleConfirm();
  }, [handleConfirm]);
  ...
  return /* @__PURE__ */ React78.createElement(
    TreeItem,
    {
      ...
      onClick: handleClick,
      label: renderLabel(
        isEditing ? /* @__PURE__ */ React78.createElement(React78.Fragment, null, /* @__PURE__ */ React78.createElement(
          InputBase2,
          {
            ...inputProps,
            ref: inputRef,
            ...
            fullWidth: true,
            disabled: isLoading,
            endAdornment: isLoading ? /* @__PURE__ */ React78.createElement(CircularProgress3, { size: 14 }) : null,
            sx: {
              ...inputProps?.sx || {},
              ...labelTextSx,
              padding: 0
        ...
        ), inputErrorPopoverAnchorEl ? /* @__PURE__ */ React78.createElement(
          Popover2,
          {
          ...
          validationErrorMessage ? /* @__PURE__ */ React78.createElement(Alert8, { severity: "error", variant: "outlined" }, validationErrorMessage) : null
...
var ExplorerHeaderContainer = styled26(Stack14)(({ theme }) => ({
  backgroundColor: theme.palette.background.paper,
  width: "100%",
  height: 36
}));
var ExplorerHeaderTitle = styled26(Typography16)(({ theme }) => ({
  fontSize: 13,
  flexGrow: 1,
...
function ExplorerHeader({
  ...
  const [isSearching, setIsSearching] = React79.useState(hasPersistentSearch);
  const [searchTerm, setSearchTerm] = React79.useState("");
  const handleSearchClick = React79.useCallback(() => {
    if (isSearching && searchTerm) {
      setSearchTerm("");
    }
    setIsSearching((previousIsSearching) => !previousIsSearching);
  }, [isSearching, searchTerm]);
  const handleSearchChange = React79.useCallback((event) => {
  ...
  return /* @__PURE__ */ React79.createElement(
    ...
    isSearching ? /* @__PURE__ */ React79.createElement(
      TextField18,
      {
        hiddenLabel: true,
        value: searchTerm,
        ...
        InputProps: {
          startAdornment: hasPersistentSearch ? /* @__PURE__ */ React79.createElement(InputAdornment5, { position: "start" }, /* @__PURE__ */ React79.createElement(SearchIcon, { fontSize: "small", sx: { mt: "-4px" } })) : null,
          sx: {
            fontSize: 14,
            borderRadius: 0
          }
    ...
    ) : /* @__PURE__ */ React79.createElement(React79.Fragment, null, headerIcon, /* @__PURE__ */ React79.createElement(
      ExplorerHeaderTitle,
      {
        variant: "body2",
        sx: {
    ...
    onSearch && searchLabelText && !hasPersistentSearch ? /* @__PURE__ */ React79.createElement(Tooltip11, { title: searchLabelText }, /* @__PURE__ */ React79.createElement(IconButton13, { "aria-label": searchLabelText, size: "medium", onClick: handleSearchClick }, /* @__PURE__ */ React79.createElement(SearchIcon, { color: isSearching ? "primary" : "inherit" }))) : null,
    onCreate && createLabelText ? /* @__PURE__ */ React79.createElement(Tooltip11, { title: createLabelText }, /* @__PURE__ */ React79.createElement(IconButton13, { "aria-label": createLabelText, size: "small", onClick: onCreate }, /* @__PURE__ */ React79.createElement(AddIcon3, null))) : null
  );
}

// src/toolpad/AppEditor/PagesExplorer/index.tsx
var PagesExplorerRoot = styled27(Stack15)({
  height: "100%",
  width: "100%"
});
var classes7 = {
...
var StyledEditableTreeItem = styled27(EditableTreeItem)({
...
function PagesExplorerTreeItem(props) {
  ...
  const handleRenameConfirm = React80.useCallback(
    (updatedName) => {
      if (onRenameNode) {
  ...
  const validateEditablePageName = React80.useCallback(
    (newName) => {
  ...
  return /* @__PURE__ */ React80.createElement(
    StyledEditableTreeItem,
    {
      itemId,
      labelText,
      renderLabel: (children) => /* @__PURE__ */ React80.createElement(Tooltip12, { title, placement: "right", disableInteractive: true }, /* @__PURE__ */ React80.createElement(Box22, { sx: { display: "flex", alignItems: "center" } }, labelIcon, children, toolpadNodeId ? /* @__PURE__ */ React80.createElement(
        NodeMenu,
        {
          renderButton: ({ buttonProps, menuProps }) => /* @__PURE__ */ React80.createElement(
            ...
            /* @__PURE__ */ React80.createElement(MoreVertIcon, { fontSize: "inherit" })
          ),
...
function PagesExplorer({ className }) {
  ...
  const existingNames = React80.useMemo(
  ...
  const pagesTreeRef = React80.useRef(null);
  const [hasMounted, setHasMounted] = React80.useState(false);
  React80.useEffect(() => {
    setHasMounted(true);
  }, []);
  React80.useEffect(() => {
  ...
  const nextProposedName = React80.useMemo(
    () => appDom23.proposeName(DEFAULT_NEW_PAGE_NAME, existingNames),
    [existingNames]
  );
  const handleCreateNewCommit = React80.useCallback(
    async (newPageName) => {
  ...
  const validatePageName = React80.useCallback(
    (pageName) => {
  ...
  const handleDeletePage = React80.useCallback(
    async (nodeId) => {
  ...
  const handleRenameNode = React80.useCallback(
    (nodeId, updatedName) => {
      appStateApi.update(
        (draft) => {
  ...
  const handleDuplicateNode = React80.useCallback(
    (nodeId) => {
  ...
  const alphabeticSortedPages = React80.useMemo(
    () => [...pages].sort(createPropComparator("name", alphabeticComparator)),
    [pages]
  );
  return /* @__PURE__ */ React80.createElement(PagesExplorerRoot, { "data-testid": "pages-explorer", direction: "column", className }, /* @__PURE__ */ React80.createElement(
    ExplorerHeader,
    {
      headerText: "Pages",
    ...
    isCreateNewPageOpen ? /* @__PURE__ */ React80.createElement(
      EditableTreeItem,
      {
        itemId: "::create::",
        isEditing: true,
    ...
    alphabeticSortedPages.map((page) => /* @__PURE__ */ React80.createElement(
...
import { Box as Box23, Typography as Typography17, styled as styled28, IconButton as IconButton15 } from "@mui/material";
...
var StyledTreeItem = styled28(EditableTreeItem)({
...
function CustomTreeItem(props) {
  ...
  const existingNames = React81.useMemo(() => appDom24.getExistingNamesForNode(dom, node), [dom, node]);
  const validateEditableNodeName = React81.useCallback(
    (newName) => {
  ...
  const handleNameSave = React81.useCallback(
    (newName) => {
  ...
  const handleNodeDelete = React81.useCallback(
    (nodeId) => {
      domApi.update((draft) => {
  ...
  const handleNodeDuplicate = React81.useCallback(
    (nodeId) => {
  ...
  const handleNodeHover = React81.useCallback(
    (event, nodeId) => {
      appStateApi.hoverNode(nodeId);
    },
    [appStateApi]
  );
  const handleNodeBlur = React81.useCallback(() => {
  ...
  return /* @__PURE__ */ React81.createElement(
    StyledTreeItem,
    {
      key: node.id,
      labelText: node.name,
      renderLabel: (children) => /* @__PURE__ */ React81.createElement(
        Box23,
        {
        ...
        children,
        node.id ? /* @__PURE__ */ React81.createElement(
          NodeMenu,
          {
            renderButton: ({ buttonProps, menuProps }) => /* @__PURE__ */ React81.createElement(
              IconButton15,
              {
              ...
              /* @__PURE__ */ React81.createElement(MoreVertIcon2, { fontSize: "inherit" })
            ),
            nodeId: node.id,
...
function RecursiveSubTree({ dom, root }) {
  const { children = [], renderItem = [] } = React81.useMemo(
    () => appDom24.getChildNodes(dom, root),
    [dom, root]
  );
  if (children.length > 0) {
    return /* @__PURE__ */ React81.createElement(CustomTreeItem, { itemId: root.id, node: root }, children.map((childNode) => /* @__PURE__ */ React81.createElement(RecursiveSubTree, { key: childNode.id, dom, root: childNode })));
  }
  if (renderItem.length > 0) {
    return /* @__PURE__ */ React81.createElement(
      CustomTreeItem,
      {
        itemId: root.id,
        node: root,
        label: /* @__PURE__ */ React81.createElement(Typography17, { variant: "body2" }, root.name)
      },
      /* @__PURE__ */ React81.createElement(
        TreeItem2,
        {
          itemId: `${root.id}-renderItem`,
          label: /* @__PURE__ */ React81.createElement(Typography17, { variant: "body2" }, "renderItem")
        },
        renderItem.map((childNode) => /* @__PURE__ */ React81.createElement(RecursiveSubTree, { key: childNode.id, dom, root: childNode }))
      )
    );
  }
  return /* @__PURE__ */ React81.createElement(CustomTreeItem, { itemId: root.id, node: root });
}
function HierarchyExplorer() {
  const { dom, currentView } = useAppState();
  const appStateApi = useAppStateApi();
  const [expandedDomNodeIds, setExpandedDomNodeIds] = React81.useState([]);
  ...
  const selectedNodeAncestorIds = React81.useMemo(() => {
  ...
  const { children: rootChildren = [] } = React81.useMemo(() => {
    if (!currentPageNode) {
      return { children: [] };
    }
    return appDom24.getChildNodes(dom, currentPageNode);
  }, [dom, currentPageNode]);
  const handleNodeSelect = React81.useCallback(
    (event, itemIds) => {
      if (!itemIds) {
        return;
      }
  ...
  const handleNodeFocus = React81.useCallback(
    (event, nodeId) => {
      appStateApi.hoverNode(nodeId);
    },
    [appStateApi]
  );
  const handleNodeToggle = React81.useCallback(
    (event, nodeIds) => {
      setExpandedDomNodeIds(nodeIds);
    },
    [setExpandedDomNodeIds]
  );
  const deleteNode = React81.useCallback(() => {
    if (!selectedDomNodeId) {
      return;
    }
    appStateApi.update(
  ...
  const handleKeyDown = React81.useCallback(
    (event) => {
  ...
  const expandedDomNodeIdSet = React81.useMemo(() => {
    return /* @__PURE__ */ new Set([...selectedNodeAncestorIds, ...expandedDomNodeIds]);
  }, [selectedNodeAncestorIds, expandedDomNodeIds]);
  return /* @__PURE__ */ React81.createElement(React81.Fragment, null, /* @__PURE__ */ React81.createElement(ExplorerHeader, { headerText: "Page hierarchy" }), /* @__PURE__ */ React81.createElement(
    SimpleTreeView2,
    {
    ...
    rootChildren.map((childNode) => /* @__PURE__ */ React81.createElement(RecursiveSubTree, { key: childNode.id, dom, root: childNode }))
  ));
}
...
function AppExportDialog({ open, onClose, dom }) {
  const dialogTitleId = React82.useId();
  return /* @__PURE__ */ React82.createElement(Dialog7, { "aria-labelledby": dialogTitleId, fullWidth: true, maxWidth: "sm", open, onClose }, /* @__PURE__ */ React82.createElement(DialogTitle7, { id: dialogTitleId }, "Application DOM"), /* @__PURE__ */ React82.createElement(DialogContent7, { sx: { position: "relative", display: "flex", alignItems: "stretch" } }, /* @__PURE__ */ React82.createElement(JsonView, { sx: { flex: 1 }, copyToClipboard: true, src: dom, expandPaths: [], expandLevel: 5 })), /* @__PURE__ */ React82.createElement(DialogActions7, null, /* @__PURE__ */ React82.createElement(Button11, { onClick: onClose }, "Close")));
}
...
function AppOptions({ dom }) {
  ...
  const handleAppExportClick = React83.useCallback(() => {
    onMenuClose();
    handleOpenAppExport();
  }, [handleOpenAppExport, onMenuClose]);
  return /* @__PURE__ */ React83.createElement(React83.Fragment, null, /* @__PURE__ */ React83.createElement(IconButton16, { ...buttonProps, "aria-label": "Application menu" }, /* @__PURE__ */ React83.createElement(MoreVertIcon3, null)), /* @__PURE__ */ React83.createElement(Menu2, { ...menuProps }, /* @__PURE__ */ React83.createElement(Divider8, null), dom ? /* @__PURE__ */ React83.createElement(MenuItem8, { onClick: handleAppExportClick }, /* @__PURE__ */ React83.createElement(ListItemIcon2, null, /* @__PURE__ */ React83.createElement(CodeIcon2, null)), /* @__PURE__ */ React83.createElement(ListItemText2, null, "View DOM")) : null), dom ? /* @__PURE__ */ React83.createElement(AppExportDialog_default, { open: appExportOpen, onClose: handleCloseAppExport, dom }) : null);
}
...
var StyledTreeItem2 = styled29(EditableTreeItem)({
...
function DataTreeItem(props) {
  ...
  const handleRenameConfirm = React84.useCallback(
    (updatedName) => {
      if (onRenameNode) {
        onRenameNode(itemId, updatedName);
        stopEditing();
  ...
  const validateEditableQueryName = React84.useCallback(
    (newName) => {
      if (newName !== labelText && validateItemName) {
        return validateItemName(newName);
      }
  ...
  const queryCreationMode = React84.useMemo(() => {
  ...
  return /* @__PURE__ */ React84.createElement(
    StyledTreeItem2,
    {
      itemId,
      labelText,
      renderLabel: (children) => /* @__PURE__ */ React84.createElement(Box24, { sx: { display: "flex", alignItems: "center" }, onClick: handleClick }, /* @__PURE__ */ React84.createElement(QueryIcon, { id: labelIconId || "query", sx: { fontSize: 24, my: 0, ...labelIconSx } }), children, onCreate ? /* @__PURE__ */ React84.createElement(
        IconButton17,
        {
        ...
        /* @__PURE__ */ React84.createElement(AddIcon4, { fontSize: "inherit" })
      ) : null, toolpadNodeId ? /* @__PURE__ */ React84.createElement(
        NodeMenu,
        {
          renderButton: ({ buttonProps, menuProps }) => /* @__PURE__ */ React84.createElement(
            IconButton17,
            {
            ...
            /* @__PURE__ */ React84.createElement(MoreVertIcon4, { fontSize: "inherit" })
          ),
          nodeId: toolpadNodeId,
          deleteLabelText,
          duplicateLabelText,
...
function CreatePopover({
  ...
  return /* @__PURE__ */ React84.createElement(
    ...
    /* @__PURE__ */ React84.createElement(Paper, { sx: { p: 2, maxWidth: 500 } }, /* @__PURE__ */ React84.createElement(Typography18, { variant: "body2", sx: { mb: 2, textAlign: "center" } }, createMode === "query" ? /* @__PURE__ */ React84.createElement(React84.Fragment, null, "Make backend data available as state on the page. Read more in the", " ", /* @__PURE__ */ React84.createElement(
      Link9,
      {
      ...
      "docs."
    )) : /* @__PURE__ */ React84.createElement(React84.Fragment, null, "Run an action on the page. Read more in the", " ", /* @__PURE__ */ React84.createElement(
      Link9,
      {
      ...
      "docs."
    ))), /* @__PURE__ */ React84.createElement(Stack16, { direction: "row", gap: 1, display: "grid", gridTemplateColumns: "1fr 1fr" }, Object.keys(client_default3).map((dataSourceId) => {
      ...
      return /* @__PURE__ */ React84.createElement(
        ...
        /* @__PURE__ */ React84.createElement(QueryIcon, { id: dataSourceId, sx: { fontSize: 28 } }),
        " ",
...
function Explorer({ nodes, setAnchorEl, nodeName, headerText }) {
  ...
  const handleQuerySelect = React84.useCallback(
    (selectedQueryId) => {
      appStateApi.openQueryTab(selectedQueryId);
    },
    [appStateApi]
  );
  const handleCreateClick = React84.useCallback(
    (event) => {
      event.stopPropagation();
      setAnchorEl(event.currentTarget);
    },
  ...
  const handleDeleteNode = React84.useCallback(
    (selectedQueryId) => {
  ...
  const existingNames = React84.useMemo(() => {
    if (!currentPageName) {
      return void 0;
    }
  ...
  const handleDuplicateNode = React84.useCallback(
    (nodeId) => {
  ...
  const validateName = React84.useCallback(
    (queryName) => {
      if (!existingNames) {
        return {
          isValid: true
  ...
  const handleRenameNode = React84.useCallback(
    (nodeId, updatedName) => {
      const node = appDom25.getNode(dom, nodeId, "query");
  ...
  return /* @__PURE__ */ React84.createElement(Stack16, { "data-testid": `${nodeName}-explorer`, sx: { height: "100%", width: "100%" } }, /* @__PURE__ */ React84.createElement(
    ExplorerHeader,
    {
      headerIcon: /* @__PURE__ */ React84.createElement(QueryIcon, { mode: nodeName }),
      headerText,
    ...
    nodes.map((node) => /* @__PURE__ */ React84.createElement(
      DataTreeItem,
      {
        key: node.id,
        itemId: node.id,
...
function QueriesExplorer() {
  ...
  const appStateApi = useAppStateApi();
  const currentPageName = currentView.name;
  const queryNodes = React84.useMemo(() => {
    if (!currentPageName) {
      return [];
    }
    if (currentPageName) {
  ...
  return /* @__PURE__ */ React84.createElement(React84.Fragment, null, /* @__PURE__ */ React84.createElement(Explorer, { nodes: queries, setAnchorEl, headerText: "Queries", nodeName: "query" }), /* @__PURE__ */ React84.createElement(
    CreatePopover,
    {
      anchorEl,
      createPopoverOpen,
...
function ActionsExplorer() {
  ...
  return /* @__PURE__ */ React84.createElement(React84.Fragment, null, /* @__PURE__ */ React84.createElement(Explorer, { nodes: actions, setAnchorEl, headerText: "Actions", nodeName: "action" }), /* @__PURE__ */ React84.createElement(
    CreatePopover,
    {
      anchorEl,
      createPopoverOpen,
...
var PagePanelRoot = styled30("div")({
  display: "flex",
  flexDirection: "column",
...
function PagePanel({ className, sx }) {
  ...
  return /* @__PURE__ */ React85.createElement(PagePanelRoot, { className, sx }, /* @__PURE__ */ React85.createElement(
    Box25,
    {
      sx: {
        pl: 2,
    ...
    /* @__PURE__ */ React85.createElement(Typography19, { noWrap: true }, project.rootDir.split(/[/\\]/).pop()),
    /* @__PURE__ */ React85.createElement(AppOptions_default, { dom })
  ), /* @__PURE__ */ React85.createElement(Divider9, null), /* @__PURE__ */ React85.createElement(resizablePanels_exports.PanelGroup, { autoSaveId: "toolpad-page-panel", direction: "vertical" }, /* @__PURE__ */ React85.createElement(resizablePanels_exports.Panel, { id: "pages-explorer", order: 1, minSize: 10, defaultSize: 25 }, /* @__PURE__ */ React85.createElement(PagesExplorer, null)), currentPageNode ? /* @__PURE__ */ React85.createElement(React85.Fragment, null, /* @__PURE__ */ React85.createElement(PanelResizeHandle, null), /* @__PURE__ */ React85.createElement(resizablePanels_exports.Panel, { id: "hierarchy-explorer", order: 2, minSize: 10, defaultSize: 25, maxSize: 90 }, /* @__PURE__ */ React85.createElement(HierarchyExplorer, null)), /* @__PURE__ */ React85.createElement(PanelResizeHandle, null), /* @__PURE__ */ React85.createElement(resizablePanels_exports.Panel, { id: "queries-explorer", order: 3, minSize: 10, defaultSize: 25, maxSize: 90 }, /* @__PURE__ */ React85.createElement(QueriesExplorer, null)), /* @__PURE__ */ React85.createElement(PanelResizeHandle, null), /* @__PURE__ */ React85.createElement(resizablePanels_exports.Panel, { id: "actions-explorer", order: 4, minSize: 10, defaultSize: 25, maxSize: 90 }, /* @__PURE__ */ React85.createElement(ActionsExplorer, null))) : null));
}
...
var MarkdownEditor = lazyComponent(() => import("./MarkdownEditor-HSG5IUHQ.mjs"), {
  noSsr: true,
  fallback: /* @__PURE__ */ React86.createElement(Skeleton4, { variant: "rectangular", height: "100%" })
});
function MarkdownPropEditor({ propType, value, onChange }) {
  const [dialogOpen, setDialogOpen] = React86.useState(false);
  useShortcut({ key: "s", metaKey: true, disabled: !dialogOpen }, () => {
    setDialogOpen(false);
  });
  return /* @__PURE__ */ React86.createElement(React86.Fragment, null, /* @__PURE__ */ React86.createElement(PropertyControl, { propType }, /* @__PURE__ */ React86.createElement(Button13, { variant: "outlined", color: "inherit", fullWidth: true, onClick: () => setDialogOpen(true) }, "Edit Markdown")), /* @__PURE__ */ React86.createElement(Dialog8, { fullWidth: true, open: dialogOpen, onClose: () => setDialogOpen(false) }, /* @__PURE__ */ React86.createElement(DialogTitle8, null, "Edit Markdown"), /* @__PURE__ */ React86.createElement(DialogContent8, null, /* @__PURE__ */ React86.createElement(Box26, { sx: { height: 200 } }, /* @__PURE__ */ React86.createElement(MarkdownEditor, { value, onChange: (newValue = "") => onChange(newValue) }))), /* @__PURE__ */ React86.createElement(DialogActions8, null, /* @__PURE__ */ React86.createElement(Button13, { color: "inherit", variant: "text", onClick: () => setDialogOpen(false) }, "Done"))));
}
...
function GridColumnEditor({
  ...
  )) : /* @__PURE__ */ React87.createElement(Typography20, { variant: "body2" }, "Grouping/aggregation", /* @__PURE__ */ React87.createElement(
    UpgradeChip,
    {
      sx: { ml: 1 },
...
var PropControlToggleButtonGroup = styled31(ToggleButtonGroup3)({
  display: "flex",
...
function SelectPropEditor2({ label, propType, value, onChange, disabled }) {
  ...
  return /* @__PURE__ */ React88.createElement(PropertyControl, { propType }, /* @__PURE__ */ React88.createElement(Box28, { sx: { my: 0.5 } }, /* @__PURE__ */ React88.createElement(Typography21, { variant: "body2" }, label), /* @__PURE__ */ React88.createElement(
    ...
    items.map((item) => /* @__PURE__ */ React88.createElement(ToggleButton3, { key: item, value: item }, enumLabels[item] || item))
  )));
}
...
function SelectOptionsPropEditor({
  ...
  const optionInputRef = React89.useRef(null);
...
import { ToggleButton as ToggleButton4, ToggleButtonGroup as ToggleButtonGroup4, Typography as Typography23 } from "@mui/material";
...
function HorizontalAlignPropEditor({
  ...
  return /* @__PURE__ */ React93.createElement(PropertyControl, { propType }, /* @__PURE__ */ React93.createElement("div", null, label ? /* @__PURE__ */ React93.createElement(Typography23, { variant: "body2" }, label, ":") : null, /* @__PURE__ */ React93.createElement(
    ...
    /* @__PURE__ */ React93.createElement(ToggleButton4, { value: "start", "aria-label": "start" }, /* @__PURE__ */ React93.createElement(AlignHorizontalLeftIcon, null)),
    /* @__PURE__ */ React93.createElement(ToggleButton4, { value: "center", "aria-label": "center" }, /* @__PURE__ */ React93.createElement(AlignHorizontalCenterIcon, null)),
    /* @__PURE__ */ React93.createElement(ToggleButton4, { value: "end", "aria-label": "end" }, /* @__PURE__ */ React93.createElement(AlignHorizontalRightIcon, null))
  )));
}
...
import { ToggleButton as ToggleButton5, ToggleButtonGroup as ToggleButtonGroup5, Typography as Typography24 } from "@mui/material";
...
function VerticalAlignPropEditor({
  ...
  return /* @__PURE__ */ React94.createElement(PropertyControl, { propType }, /* @__PURE__ */ React94.createElement("div", null, label ? /* @__PURE__ */ React94.createElement(Typography24, { variant: "body2" }, label, ":") : null, /* @__PURE__ */ React94.createElement(
    ...
    /* @__PURE__ */ React94.createElement(ToggleButton5, { value: "start", "aria-label": "start" }, /* @__PURE__ */ React94.createElement(AlignverticalTopIcon, null)),
    /* @__PURE__ */ React94.createElement(ToggleButton5, { value: "center", "aria-label": "center" }, /* @__PURE__ */ React94.createElement(AlignVerticalCenterIcon, null)),
    /* @__PURE__ */ React94.createElement(ToggleButton5, { value: "end", "aria-label": "end" }, /* @__PURE__ */ React94.createElement(AlignVerticalBottomIcon, null))
  )));
}
...
function ColorScaleListItem({
  ...
  return /* @__PURE__ */ React96.createElement(ListItem4, { ...props, sx: { ...sx, gap: 1 } }, valueLabel ? /* @__PURE__ */ React96.createElement(Typography25, null, valueLabel) : /* @__PURE__ */ React96.createElement(React96.Fragment, null, ">", /* @__PURE__ */ React96.createElement(
    Input2,
    {
      type: "number",
      value: value?.value ?? 0,
...
var DataProviderSelectorRoot = styled32("div")({
...
function CreateNewDataProviderDialog({
  ...
  ), /* @__PURE__ */ React97.createElement(FormControl, null, /* @__PURE__ */ React97.createElement(FormLabel, { id: paginationModeSelectId }, "Pagination mode"), /* @__PURE__ */ React97.createElement(
    RadioGroup,
    {
      row: true,
...
var EditorRoot = styled33("div")(({ theme }) => ({
  height: 1,
  minHeight: "100%",
  display: "flex",
  flexDirection: "column",
...
function Editor2() {
  return /* @__PURE__ */ React101.createElement(EditorRoot, null, /* @__PURE__ */ React101.createElement(FileEditor, null));
}
...
import { Stack as Stack23, styled as styled35 } from "@mui/material";

// src/toolpad/ToolpadShell/Header/index.tsx
import * as React105 from "react";
import { AppBar, Box as Box35, Toolbar as Toolbar4, Tooltip as Tooltip16, Chip as Chip5, Link as Link10, useTheme as useTheme5 } from "@mui/material";
...
var REPORT_BUG_URL = "https://github.com/mui/mui-toolpad/issues/new/choose";
var FEATURE_REQUEST_URL = "https://github.com/mui/mui-toolpad/issues";
...
// src/toolpad/ToolpadShell/index.tsx
var ToolpadShellRoot = styled35("div")({
  height: "100vh",
  display: "flex",
  flexDirection: "column"
});
var ViewPort = styled35("div")({
  flex: 1,
  width: "100%",
  overflow: "auto",
  position: "relative"
...
var FileTreeItemRoot = styled36(EditableTreeItem)(({ theme }) => ({
