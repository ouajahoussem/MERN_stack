...
declare const componentsStore: {
    ...
    useState: () => (Partial<Record<string, _toolpad_studio_runtime.ToolpadComponent<any>>> | ((newState: Partial<Record<string, _toolpad_studio_runtime.ToolpadComponent<any>>> | ((oldValue: Partial<Record<string, _toolpad_studio_runtime.ToolpadComponent<any>>>) => Partial<Record<string, _toolpad_studio_runtime.ToolpadComponent<any>>>)) => void))[];
