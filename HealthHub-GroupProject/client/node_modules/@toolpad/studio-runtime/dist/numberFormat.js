...
function NumberFormatEditor({
  ...
  return /* @__PURE__ */ React.createElement(Stack, { sx, gap: 1 }, /* @__PURE__ */ React.createElement(
    ...
    TextField,
    {
      ...
      helperText: /* @__PURE__ */ React.createElement(React.Fragment, null, "ISO 4217 currency code. See the", " ", /* @__PURE__ */ React.createElement("a", { target: "_blank", href: CURRENCY_CODES_LIST_HELP_URL, rel: "noopener noreferrer" }, "currency code list"), " ", "for available values.")
    }
  ) : null));
}
export {
