...
var DataGridComponent = React.forwardRef(function DataGridComponent2({
  ...
  return /* @__PURE__ */ React.createElement(LicenseInfoProvider, { info: LICENSE_INFO }, /* @__PURE__ */ React.createElement(Box, { ref, sx: { ...sx, width: "100%", height: "100%", position: "relative" } }, /* @__PURE__ */ React.createElement(ErrorBoundary, { fallbackRender: dataGridFallbackRender, resetKeys: [rows] }, /* @__PURE__ */ React.createElement(SetActionResultContext.Provider, { value: setActionResult }, /* @__PURE__ */ React.createElement(
    DataGridPremium,
    {
      apiRef,
      slots: {
...
//# sourceMappingURL=chunk-HDATGQJH.js.map