...
function Form({
  ...
  return /* @__PURE__ */ React.createElement(FormContext.Provider, { value: formContextValue }, hasChrome ? /* @__PURE__ */ React.createElement(Box, { sx: { ...sx, width: "100%" } }, /* @__PURE__ */ React.createElement("form", { onSubmit: form.handleSubmit(handleSubmit), onReset: handleReset }, children, /* @__PURE__ */ React.createElement(
    Box,
    {
      sx: {
        display: "flex",
...
function useFormInput({
  ...
  const formInputError = formInputName ? form?.formState.errors[formInputName] : void 0;
  ...
  React.useEffect(() => {
    if (form && !equalProperties(validationProps, previousManualValidationPropsRef.current) && form.formState.dirtyFields[formInputName]) {
...
//# sourceMappingURL=chunk-HE2K7WIE.js.map