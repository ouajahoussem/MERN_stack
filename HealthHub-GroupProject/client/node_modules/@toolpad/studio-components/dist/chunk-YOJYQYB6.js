...
function Chart({ data = [], loading, error, sx }) {
  ...
  return /* @__PURE__ */ React.createElement(Box, { sx: { ...sx, position: "relative", height: "100%", width: "100%" }, "aria-busy": loading }, displayError ? /* @__PURE__ */ React.createElement(ErrorOverlay_default, { error: displayError }) : null, loading && !error ? /* @__PURE__ */ React.createElement(
    "div",
    {
      style: {
        position: "absolute",
...
//# sourceMappingURL=chunk-YOJYQYB6.js.map