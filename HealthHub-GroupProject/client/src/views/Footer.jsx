        ...
        <footer className="bg-[#1976d2]">
            <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                <div className="md:flex md:justify-between">
                    <div className="mb-6 md:mb-0">
                        <a href="/" className="flex items-center">
                            <span className="self-center text-2xl font-semibold whitespace-nowrap text-white">HealthHub</span>
                        </a>
                    </div>
                    <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                        <div>
                            ...
                            <ul className="text-gray-400 font-medium">
                                <li className="mb-4">
                                    <a href="/home" className="hover:underline text-black">HealthHub </a>
                                </li>
                                <li>
                                    <a href="https://tailwindcss.com/" className="hover:underline  text-black">Tailwind CSS</a>
                                </li>
                            </ul>
                        </div>
                        <div>
                ...
                <div className="sm:flex sm:items-center sm:justify-between">
                    <span className="text-sm sm:text-center text-black">© 2024 <a href="/home" className="hover:underline ">HealthHub</a>. All Rights Reserved.
                    </span>
